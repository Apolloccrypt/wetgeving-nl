...
Extramurale arbeid wordt in de [Regeling tijdelijk verlaten van de inrichting](https://wetten.overheid.nl/jci1.3:c:BWBR0010171) (Rtvi) als volgt omschreven: “arbeid, verricht buiten de inrichting ten behoeve van een derde2In het beleidskader zal verder gesproken worden over een externe organisatie., alsmede het volgen van een dagopleiding buiten de inrichting.”
...
De basis voor dit hoofdstuk zijn [artikel 2 van de Regeling selectie, plaatsing en overplaatsing van gedetineerden](https://wetten.overheid.nl/jci1.3:c:BWBR0011558&artikel=2) en de [artikelen 20a](https://wetten.overheid.nl/jci1.3:c:BWBR0010171&artikel=20a) en [20ab van de Regeling tijdelijk verlaten van de inrichting](https://wetten.overheid.nl/jci1.3:c:BWBR0010171&artikel=20ab).
...
De gedetineerde die in een BBA wordt geplaatst, heeft recht op de activiteiten die genoemd worden in de [Penitentiaire beginselenwet](https://wetten.overheid.nl/jci1.3:c:BWBR0009709) (Pbw), zoals het ontvangen van bezoek, telefoongebruik, geestelijke verzorging, bibliotheek, lichamelijke oefening/sport, educatie en recreatie. Het luchten wordt op werkdagen genoten tijdens het reizen van -/naar de werkgever /dagbesteding. Op de overige dagen zal deze worden aangeboden in de BBA.
...
Op de BBA werken PIW’ers, senior casemanagers en een afdelingshoofd. De PIW’er is verantwoordelijk voor de begeleiding intramuraal/ op de leefafdeling, de uitvoering van het programma en de controle op de rechtactiviteiten. De senior casemanager heeft een toezichthoudende rol (voert de regie) als het gaat om de (basis)voorwaarden, de doelen in het D&R-plan en heeft daarbij de contacten met externe organisaties en overige betrokken ketenpartners. Dit alles onder de dagelijkse leiding van een afdelingshoofd. De senior casemanager valt onder het hoofd D&R van de PI waar de BBA-locatie is gehuisvest.

Op de BBA vinden er vervolg-trajectgesprekken plaats met de senior casemanager als regievoerder. Input voor het trajectgesprek volgt uit de bevindingen (uit de rapportages) van de Piwer/mentor, maar ook vanuit de voortgangsbesprekingen door de senior casemanager met de externe organisatie en andere belanghebbende partijen.

### 7. Huisregels BBA

De huisregels die gelden op de BBA zijn opgenomen in de [Regeling model huisregels penitentiaire inrichtingen](https://wetten.overheid.nl/jci1.3:c:BWBR0009805) als bijlage II. Deze huisregels zijn vooraf in te zien door de gedetineerde.

In de deelnameverklaring, welke onderdeel is van het plaatsingsbesluit door de SF, is opgenomen dat de gedetineerde zich conformeert aan de huisregels op de BBA. Het niet nakomen van de afspraken kan leiden tot overplaatsing.

### 8. De categorieën en de verloning
...
### 8.2. Afspraken externe organisatie

Voordat overgegaan wordt tot het aangaan van een overeenkomst met een externe organisatie wordt een locatie bezoek door de senior casemanager, een creditsafecheck en een politiescreening, [bijlage 6](https://wetten.overheid.nl/jci1.3:c:BWBR0048836&bijlage=6&z=2023-11-02&g=2023-11-02), uitgevoerd om de betrouwbaarheid van de externe organisatie vast te stellen. De uitkomst hiervan wordt door de senior casemanager meegenomen naar het MDO.
...
Gedetineerden ontvangen op de BBA minimaal 300% van het basisuurloon19Regeling arbeid gedetineerden als zakgeld, vermeerderd met de reiskostenvergoeding. Dit wordt wekelijks achteraf op hun privé bankrekening gestort. Het basisuurloon is vrij te besteden voor boodschappen, sport en overige activiteiten/ uitgaven. Indien de gedetineerde meer verdient dan 300% van het basisuurloon, wordt het meerdere gereserveerd op een geblokkeerde rekeningcourant van de gedetineerde.

### 8.3.1. Inzet geblokkeerde vergoeding t.b.v. re-integratiedoelen
