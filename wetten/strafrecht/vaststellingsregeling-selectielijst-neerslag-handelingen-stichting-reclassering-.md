...
Het BSD is opgesteld in overeenstemming met de selectiedoelstelling van de RAD/PIVOT. Bij de behandeling van het ontwerp van de [Archiefwet 1995](https://wetten.overheid.nl/jci1.3:c:BWBR0007376) (Stb. 1995, 276) in de Tweede Kamer op 13 april 1994 verwoordde de Minister van WVC deze doelstelling als volgt: het mogelijk maken van een reconstructie van de hoofdlijnen van het handelen van de overheid. Door het Convent van Rijksarchivarissen is de selectiedoelstelling vertaald in de richting van de (bewaar)doelstelling van de RAD als ‘het selecteren van handelingen van de overheid om bronnen voor de kennis van de Nederlandse samenleving en cultuur veilig te stellen voor blijvende bewaring’.
