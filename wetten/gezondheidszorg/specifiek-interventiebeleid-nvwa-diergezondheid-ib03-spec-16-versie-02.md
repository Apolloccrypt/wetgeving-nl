---
title: "Specifiek interventiebeleid NVWA diergezondheid (IB03-SPEC 16, versie 02)"
identifier: "BWBR0049231"
categorie: "Gezondheidszorg"
publicatiedatum: 2024-01-13
laatste_update: 2024-01-13
status: geldig
bron: "https://wetten.overheid.nl/BWBR0049231"
---
...
Niet alle Europese regels die zien op dieren en ziekten zijn door de [Verordening (EU) nr. 2016/429](32016R0429) vervangen. Naast de [Verordening (EU) nr. 2016/429](32016R0429) blijft een Europese richtlijn, een besluit en twee verordeningen van toepassing die gaan over overdraagbare ziekten, inclusief zoönosen (zie hoofdstuk 2.2).
...
De kwalificatie in het interventiebeleid van de boetecategorieën naar ernst kan verschillen van de kwalificatie naar ernst van de overtredingsklasse in de Regeling handhaving en overige zaken [Wet dieren](https://wetten.overheid.nl/jci1.3:c:BWBR0030250). Dit is verklaarbaar, want het doel van de kwalificering en de criteria zijn verschillend. In het specifiek interventiebeleid is het doel het bepalen van de overtredingsklasse en in de [Regeling handhaving en overige zaken Wet dieren](https://wetten.overheid.nl/jci1.3:c:BWBR0032523) gaat het om het bepalen van de hoogte van de boete.
...
Met een wettelijke norm die betrekking heeft op vergelijkbare gedragingen wordt bedoeld overtredingen uit hetzelfde deel van [Verordening (EU) 2016/429](32016R0429), zoals bijvoorbeeld tracering, monitoring, verplaatsingen, identificatie en registratie van dieren of salmonella.
...
Op basis van de [Wet dieren](https://wetten.overheid.nl/jci1.3:c:BWBR0030250) is de Minister van Landbouw, Natuur en Voedselkwaliteit bevoegd om bestuursrechtelijke maatregelen te nemen die gericht zijn op het herstel van de gevolgen van de overtreding of het voorkomen van verdere overtreding. Verder is de minister bevoegd om bij bepaalde overtredingen van de Wet dieren een bestuurlijke boete op te leggen. Deze bevoegdheden zijn mede aan de NVWA gemandateerd.
...
In het geval personen die zijn toegelaten tot het beroepsmatig verrichten van diergeneeskundige handelingen tekortschieten in de zorgplicht voor dieren, kan er een melding worden gedaan bij de klachtambtenaar ten behoeve van het Veterinair Tuchtcollege. Dit gelet op [artikel 4.2 van de Wet dieren](https://wetten.overheid.nl/jci1.3:c:BWBR0030250&artikel=4.2). Dit kan naast een bestuurlijke of strafrechtelijke interventie plaatsvinden. Personen die hier onder vallen zijn onder andere dierenartsen, dierenartsassistenten-paraveterinair en dierverloskundigen.
...
Deze beleidsregel vervangt het op 30 oktober 2023 vastgestelde [Specifiek interventiebeleid NVWA diergezondheid](https://wetten.overheid.nl/jci1.3:c:BWBR0048925) (IB02-SPEC 16, versie 01). Hiermee wordt de inhoud van de beleidsregel in overeenstemming gebracht met het [Algemeen interventiebeleid NVWA 2024](onbekend).
