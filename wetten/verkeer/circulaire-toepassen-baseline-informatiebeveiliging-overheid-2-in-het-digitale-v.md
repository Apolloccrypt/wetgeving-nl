...
Iedere overheidslaag heeft in een eerder stadium besloten de BIO toe te passen. Dit is bevestigd in de Ministerraad van 14 december 2018. Dat is met u gedeeld middels de [circulaire 2019-0000184156](https://wetten.overheid.nl/jci1.3:c:BWBR0042237) van 16 april 2019.
...
Deze versie vervangt per heden de versie 1.04 in het digitale verkeer met het Rijk en tevens de versie 1.2 die in het Overheidsbreed Beleidsoverleg Digitale Overheid (OBDO) van 23 september 2025 is vastgesteld. Daarmee komt ook de [circulaire 2019-0000684575](https://wetten.overheid.nl/jci1.3:c:BWBR0043146) te vervallen.
...
Overheidsorganisaties die gebruik willen maken van het ondersteuningsprogramma kunnen terecht op [www.bio-overheid.nl](https://www.bio-overheid.nl).
...
Het gebruik van informatie uit NEN-EN-ISO/IEC 27001 en NEN-EN-ISO/IEC 27002 in de BIO is auteursrechtelijk beschermd. Het gebruik van teksten uit deze normen in de BIO geschiedt met toestemming van NEN. Voor meer informatie over de NEN en het gebruik van hun producten zie: [www.nen.nl](http://www.nen.nl/).
