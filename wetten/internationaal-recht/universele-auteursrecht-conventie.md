...
The original title and the name of the author of the work shall be printed on all copies of the published translation. The license shall be valid only for publication of the translation in the territory of the Contracting State where it has been applied for. Copies so pubblished may be imported and sold in another Contracting State if one of the national languages of such other State is the same language as that into which the work has been so translated, and if the domestic law in such other State makes provision for such licenses and does not prohibit such importation and sale. Where the foregoing conditions do not exist, the importation and sale of such copies in a Contracting State shall be governed by its domestic law and its agreements. The license shall not be transferred by the licensee.
