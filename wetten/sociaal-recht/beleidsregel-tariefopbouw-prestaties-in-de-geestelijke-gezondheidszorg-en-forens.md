...
- –. **NZa:** Nederlandse Zorgautoriteit, als genoemd in [artikel 3 van de Wmg](https://wetten.overheid.nl/jci1.3:c:BWBR0020078&artikel=3);

- –. **Prestatie:** Een zorgproduct gedefinieerd door de NZa, zoals bedoeld in [artikel 1, onderdeel j van de Wmg](https://wetten.overheid.nl/jci1.3:c:BWBR0020078&artikel=1);

- –. **Productie:** de aantallen van alle prestaties in het kader van het zorgprestatiemodel, de verblijfsprestaties [Wlz](https://wetten.overheid.nl/jci1.3:c:BWBR0035917) met behandeling en de vergoedingen in het kader van ggz-opleidingen, die voldoen aan alle eisen daaraan gesteld, geleverd in het uitvraagjaar; voor zover het ZPM of Wlz-prestaties betreft onafhankelijk óf en door wie die prestaties betaald worden een en ander zoals bekend op het moment van de uitvraag;
...
- –. **Tarief:** prijs voor een prestatie, een deel van een prestatie of geheel van prestaties van een zorgaanbieder als bedoeld in [artikel 1 sub k van de Wmg](https://wetten.overheid.nl/jci1.3:c:BWBR0020078&artikel=1).;
...
- –. **Wfz:** [Wet forensische zorg](https://wetten.overheid.nl/jci1.3:c:BWBR0040634);
...
- –. **Wmo:** [Wet maatschappelijke ondersteuning](https://wetten.overheid.nl/jci1.3:c:BWBR0035362);

- –. **Zorg:** zorg als bedoeld in [artikel 1, aanhef en onder b, van de Wmg](https://wetten.overheid.nl/jci1.3:c:BWBR0020078&artikel=1) en forensische zorg als omschreven bij of krachtens [artikel 1.1, tweede lid, van de Wfz](https://wetten.overheid.nl/jci1.3:c:BWBR0040634&artikel=1.1);
...
De kostprijzen worden, indien van toepassing, aangevuld met een normatieve toeslag voor huisvesting, inventaris en ondernemingsfinanciering zoals verder uitgewerkt in [artikel 9r](https://wetten.overheid.nl/jci1.3:c:BWBR0051498&artikel=9&z=2026-01-01&g=2026-01-01) van deze beleidsregel.
...
4.2. De tarieven worden jaarlijks aangepast aan het geldende prijspeil op basis van indexatie. Hiervoor worden verschillende prijsindexcijfers gehanteerd, zoals beschreven in [artikel 12](https://wetten.overheid.nl/jci1.3:c:BWBR0051498&artikel=12&z=2026-01-01&g=2026-01-01) van deze beleidsregel.
...
7.2. Voor de volgende prestaties worden de tarieven op een andere wijze bepaald dan op basis van de uitkomsten uit het kostprijsonderzoek als bedoeld in [artikel 4.1](https://wetten.overheid.nl/jci1.3:c:BWBR0051498&artikel=4&z=2026-01-01&g=2026-01-01) van deze beleidsregel.

- a). Zorgmachtiging [Wet verplichte ggz](https://wetten.overheid.nl/jci1.3:c:BWBR0040635); dit tarief wordt geïndexeerd
...
- m). Vpt; tarieven worden één op één overgenomen uit [Wlz](https://wetten.overheid.nl/jci1.3:c:BWBR0035917), met dien verstande dat bij vpt met dagbesteding hier de nhc-verhoging als gevolg van verduurzaming en brandveiligheid doorgevoerd is.

- n). ZZP-VG en H152 Begeleiding speciaal 1 NAH; tarieven worden gebaseerd op de kostprijzen uit de [Wlz](https://wetten.overheid.nl/jci1.3:c:BWBR0035917)
...
- q). H811 t/m H813 dagbesteding VG; tarieven worden gebaseerd op de kostprijzen uit de [Wlz](https://wetten.overheid.nl/jci1.3:c:BWBR0035917).
...
9.2. De NZa heeft in de ‘Beleidsregel Algemeen kader tariefprincipes’ (BR/REG-21152) en Afronding tarieven- AL/BR-0031, waarin opgenomen welke uitgangspunten de NZa hanteert bij het vaststellen van tarieven. Het beleid voor de tarieven in de [Zvw](https://wetten.overheid.nl/jci1.3:c:BWBR0018450), [Wlz en](https://wetten.overheid.nl/jci1.3:c:BWBR0035917) de fz sluit hierop aan.
...
- a). ZPM-prestaties Voor de ZPM-prestaties geldt vervolgens dat indexering plaatsvindt op basis van een verhouding tussen het prijsindexcijfer personele kosten en het prijsindexcijfer materiële kosten. De volgende verhouding wordt toepast: Als prestaties, of onderdelen van prestaties, zijn afgeleid van andere prestaties of andere sectoren, dan volgt de NZa in beginsel de indexatie van die sector.
