...
Inmiddels zijn ook de (GBA-) software-leveranciers op de hoogte gebracht van de nieuwe clausules.

Ik ga er van uit dat u met ingang van 1 januari 1998 de bijgaande lijst met paspoortclausules bij de verstrekking van reisdocumenten zult hanteren.
...
Ic gehuwd geweest met/

formerly married to/

anciennement marié(e) à

Id geregistreerde partner van/

registered partner of/

partenaire enregistré(e) de

Ie geregistreerde partner geweest van/

former registered partner of/

ancien partenaire enregistré(e) de

If e/v (e/v = echtgenoot/echtgenote van)

Ig w/v (w/v = weduwe/weduwnaar van)

Ih g/v (g/v = gescheiden van)

Ii p/v (p/v = geregistreerde partner van)

Ij b/v (b/v = gescheiden geregistreerde partner van)

Ik a/v (a/v = achtergebleven geregistreerde partner van)
