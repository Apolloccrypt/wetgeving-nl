...
2. The homeworking allowance per day is equal to 10% of the gross hourly pay corresponding to the highest pay number of pay scale 7 that applies on the date of payment at the mission where the employee works.
...
3. The supplement referred to in paragraph 1 is granted to a child as referred to in that paragraph with effect from the first day of the month following the month in which the employee or ex-employee dies. The provision of the supplement ends:
