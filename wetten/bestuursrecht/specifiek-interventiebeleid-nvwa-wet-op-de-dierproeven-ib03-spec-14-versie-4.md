...
citeertitel: "Specifiek interventiebeleid NVWA Wet op de dierproeven (IB03-SPEC 14, versie 4)"
identifier: "BWBR0049228"
categorie: "Milieu"
soort: "beleidsregel"
...
status: geldig
toestand: 2024-01-13
bron: "https://wetten.overheid.nl/BWBR0049228"
...
Gelet op [artikel 4:81 van de Algemene wet bestuursrecht](https://wetten.overheid.nl/jci1.3:c:BWBR0005537&artikel=4:81), [artikel 20 van de Wet op de dierproeven](https://wetten.overheid.nl/jci1.3:c:BWBR0003081&artikel=20), [artikel 6, zevende lid, van het Besluit mandaat, volmacht en machtiging LNV 2019](https://wetten.overheid.nl/jci1.3:c:BWBR0041794&artikel=6) en het Algemeen interventiebeleid NVWA 2024;

Besluit vast te stellen de volgende beleidsregel:

### 1. Onderwerp

Dit specifieke interventiebeleid beschrijft, binnen de kaders van het [Algemeen interventiebeleid NVWA 2024](https://wetten.overheid.nl/jci1.3:c:BWBR0049215) (AIB), de klasseindeling van en interventies voor specifieke overtredingen van de regelgeving met betrekking tot proefdieren en dierproeven.
...
- – *Proefdieren:* Dieren zoals bedoeld in [artikel 1b Wet op de dierproeven](https://wetten.overheid.nl/jci1.3:c:BWBR0003081&artikel=1b) (Wod).

- – *Dierproeven:* Gebruik van een proefdier zoals omschreven in [artikel 1 lid 1 sub a van de Wod](https://wetten.overheid.nl/jci1.3:c:BWBR0003081&artikel=1).
...
- • [Wet op de dierproeven](https://wetten.overheid.nl/jci1.3:c:BWBR0003081) (Wet van 12 januari 1977, houdende regelen met betrekking tot het verrichten van proeven op dieren);

- • [Dierproevenbesluit 2014](https://wetten.overheid.nl/jci1.3:c:BWBR0035866);

- • [Dierproevenregeling 2014](https://wetten.overheid.nl/jci1.3:c:BWBR0035873);

- • En andere relevante regelgeving waaronder besluiten en beleidsregels zoals, maar niet gelimiteerd tot: [Besluit inzake aanwijzing cursus proefdierkunde](https://wetten.overheid.nl/jci1.3:c:BWBR0003884), [Besluit aanwijzing toezichthouders Wet op de dierproeven](https://wetten.overheid.nl/jci1.3:c:BWBR0036837), Erkenningen dierexperimentencommissies.
...
In de [bijlage](https://wetten.overheid.nl/BWBR0049228) van dit document zijn de bepalingen van de geldende wetgeving ingedeeld in een overtredingsklasse met bijbehorende interventie(s).

### 3.2. Het bepalen van interventies bij een overtreding

Bestraffende sanctie

De Wod stelt in [artikel 25](https://wetten.overheid.nl/jci1.3:c:BWBR0003081&artikel=25) vele overtredingen strafbaar. De meeste overtredingen zijn tevens als misdrijf aangemerkt. Overtredingen van de artikelen die in artikel 25, lid 2, van de Wod als ‘misdrijf’ worden aangemerkt, zijn ingedeeld in overtredingsklasse zwaar. Ook pogingen tot misdrijven zijn strafbaar. Door de aard van instellingsvergunninghouders en de veelal open wettelijke normen, die daarnaast soms ook nog onderling strijdig zijn en tegen elkaar moeten worden afgewogen (de 3 V’s van vervanging, vermindering en verfijning), wordt toepassing van het strafrecht in overleg met het OM bepaald.
...
Deze beleidsregel vervangt het 24 november 2020 vastgestelde [Specifiek interventiebeleid NVWA Wet op de dierproeven (IB02-SPEC 14, versie 3)](https://wetten.overheid.nl/jci1.3:c:BWBR0044441). Hiermee wordt de inhoud van de beleidsregel in overeenstemming gebracht met het [Algemeen interventiebeleid NVWA 2024](https://wetten.overheid.nl/jci1.3:c:BWBR0049215). Tevens wordt de bijlage vanaf nu weergegeven op de website van de NVWA (www.nvwa.nl/interventiebeleid).
...
De [bijlage](https://wetten.overheid.nl/BWBR0049228) van deze beleidsregel is te vinden op de website van de Nederlandse Voedsel- en Warenautoriteit (www.nvwa.nl/interventiebeleid).
