...
Maatwerk voor de toepassing van het VWNW-beleid wordt mogelijk gemaakt voor groepen personeel. Dit kan, ondermeer afhankelijk van de omvang van de reorganisatie of de doelgroep van de organisatie, maatwerk in de aanspraak op VWNW-voorzieningen ([artikel 49ff t/m 49ss van het ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=49ff)) zijn als ook maatwerk in het plaatsingsbereik ([artikel 49cc van het ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=49cc)), als kenmerken van de doelgroep of specifieke omstandigheden daartoe aanleiding geven. Afspraken over maatwerk worden in het decentraal georganiseerd overleg voorbereid en dienen ter toetsing aan het Sectoroverleg Rijk te worden voorgelegd alvorens deze definitief te maken. Maatwerk is alleen mogelijk als daar aanleiding voor is en geldt uitsluitend als uitzondering.

### Functievolgers

Doordat [artikel 57, tweede lid, van het ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=57) geen werking heeft gedurende de looptijd van het VWNW-beleid (en nu zal vervallen), is (onbedoeld) de grondslag vervallen voor het plaatsen van ambtenaren die in een reorganisatie niet overtollig worden en waarvan de functie niet wordt opgeheven, maar die wel geplaatst worden in een andere passende functie. Voor het plaatsen van deze ‘functievolgers’ is een grondslag in het [ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950) nodig.
...
Volgens de regelgeving ([artikel 22, negende lid, van het ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=22)) stopt de verlofopbouw van de verplichte VWNW-kandidaat als hij geen dienst meer verricht. In de praktijk laten departementen de verlofopbouw van de verplichte VWNW-kandidaat doorlopen, ook als er geen dienst wordt verricht. Dit stelt VWNW-kandidaten in staat vrij te nemen van de zoektocht naar ander werk. De regelgeving behoeft aanvulling.

Afspraak:

Tijdens de verplichte fase loopt de verlofopbouw van de VWNW-kandidaat door. [Artikel 22 van het ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=22) zal hiervoor worden aangepast.
...
Aanspraak op de proportionele ambtsjubileumgratificatie zoals bedoeld in [artikel 49pp van het ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=49pp) zal in de voorbereidende fase ook gelden voor de vertrekkende medewerker die geen VWNW-onderzoek heeft gedaan.
...
### Bijlage: wijze van monitoring voorzieningen bwWW

### Paragraaf 6.4: verlenging uitkering bwWW tot AOW-leeftijd

Vanaf 1 januari 2018 tot en met 31 december 2021 wordt de instroom in de uitkering op grond van de bwWW en na ontslag op grond van [artikel 99 ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=99) gevolgd voor de toepassing van de verlenging van de uitkering tot aan de AOW-leeftijd.

Hiervoor vindt opbouw plaats van een geanonimiseerd bestand naar:

Vanaf het van toepassing worden van de transitievergoeding wordt het bestand aangevuld met:

Dit is een groeiend bestand vanaf 1 januari 2018 tot en met 31 december 2021.

### Paragraaf 6.7: toepassing ontslag op basis van [artikel 99 van het ARAR](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=99)

Vanaf 1 januari 2018 tot een half jaar voor de invoering van de transitievergoeding wordt de instroom en de uitstroom in [artikel 99](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=99) aanvullend gevolgd voor de toepassing van ontslag op grond van artikel 99.

Hiervoor wordt de opbouw van het hierboven genoemde geanonimiseerde bestand in geval van ontslag op grond van [artikel 99](https://wetten.overheid.nl/jci1.3:c:BWBR0001950&artikel=99) aangevuld met:
