...
citeertitel: "Beleidsregel toepassen beoordelingsregels aanvraag omgevingsvergunning archeologische rijksmonumentenactiviteit"
...
De beoordelingsregels in het [tweede lid van artikel 8.80 Bkl](https://wetten.overheid.nl/jci1.3:c:BWBR0041313&artikel=8.80) vloeien voort uit internationaalrechtelijke beginselen. De onderdelen a en d van dat artikellid hebben (ook) betrekking op het belang van de archeologische monumentenzorg.2De overige beginselen in artikel 8.80, tweede lid, Besluit kwaliteit leefomgeving, die in de onderdelen b en c, zijn niet op archeologische monumenten van toepassing maar alleen op monumenten.
...
Een omgevingsvergunning wordt geweigerd als het onderzoek nodeloos beschadigend is, niet noodzakelijk is, of als de aanvrager niet bereid is tot een noodzakelijke aanpassing van het onderzoek. Zie ook hier de [bijlage](https://wetten.overheid.nl/BWBR0047270) voor een grafische weergave.

### Paragraaf 3. Vergunningvoorschriften

### 3.1. Grondslag vergunningvoorschriften

Op grond van [artikel 5.34, eerste lid, Omgevingswet](https://wetten.overheid.nl/jci1.3:c:BWBR0037885&artikel=5.34), is het bevoegd gezag verplicht om aan een omgevingsvergunning voorschriften te verbinden als de in de beoordelingsregels opgenomen belangen dat nodig maken. De voorschriften mogen dus alleen met het oog op de beoordelingsregels worden opgenomen. [Artikel 8.81 Bkl](https://wetten.overheid.nl/jci1.3:c:BWBR0041313&artikel=8.81) stelt verduidelijkende regels over de wijze van toepassing van voorschriften door het bevoegd gezag. Een aantal voorschriften wordt standaard aan de omgevingsvergunning verbonden. Deze voorschriften moeten een tijdige en juiste uitvoering borgen van de (archeologische) werkzaamheden, conform de verleende vergunning. Daarnaast kunnen aan de omgevingsvergunning specifieke voorschriften worden verbonden. Dit zijn bijvoorbeeld de voorschriften, bedoeld in [artikel 8.81 Bkl](https://wetten.overheid.nl/jci1.3:c:BWBR0041313&artikel=8.81).
...
Naast de standaardvoorschriften kunnen op grond van [artikel 8.81 Bkl](https://wetten.overheid.nl/jci1.3:c:BWBR0041313&artikel=8.81) ook specifieke voorschriften worden verbonden aan een omgevingsvergunning voor een rijksmonumentenactiviteit. Dat kunnen onder meer de volgende voorschriften zijn.
...
Dit besluit treedt in werking op het moment dat de [Omgevingswet](https://wetten.overheid.nl/jci1.3:c:BWBR0037885) in werking treedt.

### 4.2. Citeertitel

Dit besluit wordt aangehaald als: Beleidsregel toepassen beoordelingsregels aanvraag omgevingsvergunning archeologische rijksmonumentenactiviteit.
