...
1. Dit reglement is van toepassing op aanvragen voor projecten, programma's of anderszins in een deelregeling benoemde activiteiten op het gebied van digitale cultuur, vormgeving en architectuur en alle mogelijke crossovers tussen en binnen deze disciplines.
...
1. Voor het verkrijgen van een subsidie van het Stimuleringsfonds moet de aanvrager staan ingeschreven in het Handelsregister bij de Kamer van Koophandel, dan wel een vergelijkbare buitenlandse organisatie.
...
- c. projecten met een looptijd langer dan 24 maanden, tenzij daar expliciete toestemming voor is gegeven;
...
2. Aanvragen moeten in de Nederlandse, Friese of Engelse taal zijn gesteld.
...
1. Een subsidie wordt altijd verleend onder de voorwaarde dat voldoende gelden aan het Stimuleringsfonds ter beschikking worden gesteld en het voor de betreffende aanvraagronde beschikbaar gestelde budget niet wordt overschreden.
...
- a. het beschikbare bedrag wordt toegekend aan de aanvragers waarvan de aanvraag het hoogst wordt gewaardeerd, waarbij aan de hoogst gewaardeerden de gevraagde bijdrage kan worden verleend zo lang het totaal daarvan het subsidieplafond niet overschrijdt, waarna aan de aanvrager aan wie toekenning zou leiden tot overschrijding van het subsidieplafond slechts het bedrag wordt toegekend dat resteert tot aan het subsidieplafond;

- b. het beschikbare bedrag wordt toegekend aan de aanvragers waarvan de aanvraag het hoogst wordt gewaardeerd tot en met de aanvraag, waarvan toekenning zou leiden tot overschrijding van het subsidieplafond, met dien verstande dat het beschikbare bedrag alsdan naar rato over hen wordt verdeeld;

- c. het beschikbare bedrag naar rato wordt verdeeld over de aanvragers die voor subsidie in aanmerking komen.
...
- a. aansluit bij de doelstelling of doelstellingen van de betreffende deelregeling;

- b. voldoende consistent is in doel, opzet, betrokken deskundigheid, wijze en mate van cofinanciering en publieksbereik;

- c. aansluit bij een of meer van de algemene doelstellingen, zoals geformuleerd in [artikel 2](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=2&z=2018-01-01&g=2018-01-01).
...
- b. nadere vereisten die betrekking hebben op de uitvoering van het project en die zijn vastgesteld door het bestuur en opgenomen in de aanvraagformulieren of in de aankondiging op de website. Deze vereisten worden minimaal vier weken voor de vastgestelde sluitingsdatum bekendgemaakt;

- c. prioriteiten zoals bedoeld in [artikel 9, tweede lid, onder b](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=9&z=2018-01-01&g=2018-01-01);
...
- b. een kopie van de voor de aanvrager geldende statuten en een uittreksel uit het Handelsregister of een daarmee gelijk te stellen buitenlandse registratie dat niet ouder is dan drie maanden;
...
- b. een omschrijving van het belang van het project, die het mogelijk maakt te beoordelen of het aansluit bij de criteria en doelstellingen van het Stimuleringsfonds zoals geformuleerd in [artikel 1](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=1&z=2018-01-01&g=2018-01-01), [2](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=2&z=2018-01-01&g=2018-01-01), [5](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=5&z=2018-01-01&g=2018-01-01) en [14 tot en met 21](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=14&z=2018-01-01&g=2018-01-01) van dit reglement en de betreffende deelregeling.
...
In de aanvraag is tenminste de volgende informatie opgenomen:
...
3. Het adviesorgaan geeft een oordeel over de mate waarin een aanvraag voldoet aan het bepaalde in het Subsidiereglement, met name aan de in [artikelen 12 tot en met 21](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=12&z=2018-01-01&g=2018-01-01), en de in de van toepassing zijnde deelregeling gestelde criteria.

4. Een positief advies kan vergezeld gaan van een beargumenteerde aanbeveling over de hoogte van de te verlenen subsidie en van onderbouwde aanbevelingen met betrekking tot de uitvoering van het project.
...
4. Bij de verantwoording, zoals genoemd in de [artikelen 26 tot en met 30](https://wetten.overheid.nl/jci1.3:c:BWBR0040298&artikel=26&z=2018-01-01&g=2018-01-01), wordt ingegaan op de daadwerkelijke uitvoering van het project.
...
3. Het verslag bevat, voor zover van toepassing, een analyse van verschillen tussen de voorgenomen activiteiten en beoogde resultaten, vermeld in de beschrijving van het project, en de feitelijke realisatie.

4. Bij deelregeling of bij beschikking kan worden bepaald dat de subsidieontvanger op een andere wijze aantoont dat de activiteiten waarvoor de subsidie is verstrekt, zijn verricht en dat is voldaan aan de aan de subsidie verbonden verplichtingen.
...
1. Uiterlijk 22 weken nadat het project heeft plaatsgevonden en/of is afgerond, moet de aanvraag tot subsidievaststelling zijn ingediend.
...
3. Op 1 januari 2018 vervallen alle reglementen en (deel-)regelingen, onder welke benaming dan ook, die op 31 december 2017 binnen het Stimuleringsfonds van kracht waren, met dien verstande dat zij van toepassing blijven op alle voor 1 januari 2018 ingediende aanvragen.

##### Artikel 35. Citeertitel

Deze regeling wordt aangehaald als: Subsidiereglement Stimuleringsfonds Creatieve Industrie 2018.
