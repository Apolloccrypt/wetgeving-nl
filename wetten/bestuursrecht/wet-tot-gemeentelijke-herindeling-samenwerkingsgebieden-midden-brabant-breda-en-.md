...
6. Indien de situatie bedoeld in het vijfde lid zich voordoet, worden in 1999 in de nieuwe gemeenten op de uit de [Kieswet](https://wetten.overheid.nl/jci1.3:c:BWBR0004627) voortvloeiende datum verkiezingen voor de gemeenteraden gehouden. De stemming voor deze verkiezingen kan plaatsvinden in hetzelfde stemlokaal als de stemming voor de verkiezingen voor provinciale staten. De op grond van [artikel J6 van de Kieswet](https://wetten.overheid.nl/jci1.3:c:BWBR0004627&artikel=J_6) gegeven voorschriften zijn van overeenkomstige toepassing.
