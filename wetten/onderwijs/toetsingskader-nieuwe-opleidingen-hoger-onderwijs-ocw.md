...
citeertitel: "Toetsingskader nieuwe opleidingen hoger onderwijs (OCW)"
...
De beslissing over accreditatie van een nieuwe opleiding wordt gebaseerd op een toets aan de hand van zes *onderwerpen.*1In de [WHW art. 5.8,lid 2](https://wetten.overheid.nl/jci1.3:c:BWBR0005682) wordt hiervoor het begrip 'aspect van kwaliteit' gehanteerd.
...
De genoemde onderwerpen worden beoordeeld aan de hand van *facetten* en daarbij behorende *criteria* (zie [hoofdstuk 2](https://wetten.overheid.nl/BWBR0015216)).

Voor de toetsing van nieuwe opleidingen zijn *beslisregels* vastgesteld (zie [hoofdstuk 3](https://wetten.overheid.nl/BWBR0015216)).
...
De NAO baseert haar oordeel over de nieuwe opleiding op een toets, die in haar opdracht wordt uitgevoerd. Deze toets resulteert in een toetsingsrapport. Er zijn criteria opgesteld voor de beoordeling daarvan (zie [hoofdstuk 4](https://wetten.overheid.nl/BWBR0015216) over *de werkwijze toetsing nieuwe opleidingen).*

### 2. Beoordelingskader 2Als de opleiding in verschillende varianten wordt aangeboden (voltijd, deeltijd en/of duaal) dient waar relevant in de beoordeling duidelijk te worden dat voor elke variant de basiskwaliteit volgens de criteria uit dit beoordelingskader is gewaarborgd.
