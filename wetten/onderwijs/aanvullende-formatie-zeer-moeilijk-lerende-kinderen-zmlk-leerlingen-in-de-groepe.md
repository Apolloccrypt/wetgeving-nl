...
De procedures voor indicatiestelling zijn geregeld in de [Wet op de expertisecentra](onbekend) en het daarop gebaseerde [Besluit leerlinggebonden financiering](onbekend) (Stb. 2002, 107). De criteria die gelden bij de indicatiestelling liggen vast in de ministeriële regeling indicatiecriteria lgf.

De formatieve omvang van het leerlinggebonden budget is geregeld in het [Formatiebesluit WPO](onbekend).
