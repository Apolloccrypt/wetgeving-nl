...
2. Het bestuur kan specifieke subsidierondes uitschrijven voor de verschillende aanvraagmogelijkheden voor subsidie. Informatie over indienrondes en eventuele indienstops wordt gepubliceerd op de website van het Fonds ([www.filmfonds.nl](http://www.filmfonds.nl/)).
...
- c. de ontvanger van de subsidie dient aan te tonen dat deze tegen betaling van een billijke vergoeding beschikt over de exclusieve verfilmings- en exploitatierechten; en
...
2. Een aanvrager die voldoet aan het gestelde in [artikel 5 lid 1](https://wetten.overheid.nl/jci1.3:c:BWBR0050627&artikel=5&z=2025-01-01&g=2025-01-01) kan een aanvullende bijdrage aanvragen voor de inzet van een deskundig adviseur en regisseur. Bij een lange animatiefilm kan een aanvullende bijdrage in de ontwikkeling van concept art, karakterontwerp of een beat- of storyboard worden aangevraagd.
...
- a. de artistieke ontwikkeling van een filmproductie, die is gericht op de definitieve uitwerking van het scenario, de visuele stijl en van bepalende creatieve en technische aspecten; en

- b. de productieontwikkeling die is gericht op de uitwerking van de zakelijke en productionele opzet van een filmproductie inclusief visie op publieksbereik en duurzaamheid.
...
- a. In een eerder stadium een bijdrage voor scenario-ontwikkeling voor de filmproductie is verleend;

- b. het scenario naar het oordeel van het bestuur in zodanig vergevorderd stadium is en van zodanige kwaliteit, dat een verdere uitwerking naar een definitief scenario met bijbehorende creatieve, technische en productionele elementen noodzakelijk is om te bepalen of verfilming van het scenario kansrijk en haalbaar is;
...
2. Het bestuur kan besluiten een speciale ronde uit te schrijven voor een internationaal ontwikkeltraject voor teams van filmprofessionals.
...
2. De impulsbijdrage wordt uitsluitend toegekend indien de referentiefilm:

- a. gesteund is door het Fonds met een realiseringsbijdrage;

- b. in het voorliggend kalenderjaar in première is gegaan;
...
4. In de regeling gepubliceerd op de website van het Fonds wordt een nadere invulling geven aan de voorwaarden voor de impulsbijdrage.
