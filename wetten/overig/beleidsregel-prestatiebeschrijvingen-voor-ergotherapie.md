...
status: geldig
toestand: 2026-01-01
bron: "https://wetten.overheid.nl/BWBR0050980"
...
Het doel van deze beleidsregel is om vast te leggen op welke wijze de NZa gebruik maakt van haar bevoegdheid om tarieven en prestatiebeschrijvingen vast te stellen op het gebied van ergotherapeutische zorg.

##### Artikel 2. Reikwijdte

Deze beleidsregel is van toepassing op ergotherapeutische zorg als omschreven bij of krachtens [Zorgverzekeringswet](https://wetten.overheid.nl/jci1.3:c:BWBR0018450) (Zvw).
...
- i. Individuele zitting ouderenergotherapie
...
- p. Toeslag voor zorg aan huis of op school

- q. Toeslag voor zorg in een instelling

- r. Toeslag voor zorg op de werkplek

- s. Informatieverstrekking aan derden

- t. Meekijkconsult: inroepen van deskundigheid van een andere zorgverlener

- u. Onderling dienstverlening
...
Ad i) Individuele zitting ouderenergotherapie

De individuele zitting ouderenergotherapie is een onafgebroken tijdspanne, waarin de zorgverlener de patiënt één-op-één voor één of meerdere aandoeningen begeleidt, adviseert en/of behandelt ongeacht de inhoud van de behandeling.

Ad j, k, l, m) Groepszitting voor behandeling van twee, drie, vier of vijf tot en met tien personen
...
Er is sprake van een groepsbehandeling indien twee of meer personen tegelijkertijd starten met de zitting bij één behandelaar.
...
Ad n) Groepszitting voor behandeling van meer dan tien personen
...
Ad p) Toeslag voor zorg aan huis of op school
...
- • de behandeling vindt plaats bij de patiënt thuis of op school, niet zijnde een instelling als bedoeld in de [Wet toelating zorginstellingen](https://wetten.overheid.nl/jci1.3:c:BWBR0018906);
...
Ad q) Toeslag voor zorg in een instelling
...
Ad r) Toeslag voor zorg op de werkplek
...
Ad s) Informatieverstrekking aan derden
...
Ad t) Meekijkconsult: inroepen van deskundigheid van een andere zorgverlener
...
Ad u) Onderlinge dienstverlening
...
De NZa kan een prestatiebeschrijving vaststellen voor de in [artikel 2](https://wetten.overheid.nl/jci1.3:c:BWBR0050980&artikel=2&z=2026-01-01&g=2026-01-01) aangeduide zorg die afwijkt van de hiervoor vermelde prestatiebeschrijvingen, indien tenminste één zorgverlener en tenminste één ziektekostenverzekeraar gezamenlijk daarom verzoeken. Andere verzoeken dan gezamenlijke worden zonder inhoudelijke beoordeling afgewezen.
...
3. De prestaties ergotherapie (met uitzondering van de toeslag prestaties p, q en r) worden in tijdseenheden van 15 minuten gedeclareerd. Dit betekent dat de behandeltijd dient te worden afgerond naar het dichtstbijzijnde veelvoud van 15 minuten. De afronding van de behandeltijd mag niet uitkomen op minder dan 15 minuten.
...
- a. De volgende prestaties of een combinatie van deze prestaties kunnen wel meerdere keren per dag in rekening gebracht worden indien er een medische noodzaak bestaat voor meerdere prestaties op één dag, gesteld door een arts of de regiebehandelaar in het kader van de gzsp:
   ...
   - • Individuele zitting ouderenergotherapie (prestatie i);

   - • Groepszitting voor behandeling van twee personen (prestatie j);

   - • Groepszitting voor behandeling van drie personen (prestatie k);

   - • Groepszitting voor behandeling van vier personen (prestatie l);

   - • Groepszitting voor behandeling van vijf tot en met tien personen (prestatie m);

   - • Groepszitting voor behandeling van meer dan tien personen (prestatie n);
...
- e. De prestaties: *kunnen alleen in combinatie met één van de volgende prestaties in rekening worden gebracht:*
   ...
   - • Toeslag voor zorg aan huis of op school (prestatie p);

   - • Toeslag voor zorg in een instelling (prestatie q);

   - • Toeslag voor zorg op de werkplek (prestatie r),
   ...
   - • Instructie/overleg ouders/verzorgers van de patiënt (prestatie o);
...
Gelijktijdig met de inwerkingtreding van deze beleidsregel wordt de [Beleidsregel prestatiebeschrijvingen voor ergotherapie](https://wetten.overheid.nl/jci1.3:c:BWBR0047864), met kenmerk BR/REG-24106, ingetrokken.

Gelijktijdig met de inwerkingtreding van deze beleidsregel wordt de gepubliceerde maar nog niet in werking getreden [Beleidsregel prestatiebeschrijvingen voor ergotherapie](https://wetten.overheid.nl/jci1.3:c:BWBR0050753), met kenmerk BR/REG-26103, ingetrokken.

##### Artikel 8. Toepasselijkheid voorafgaande beleidsregel, bekendmaking, inwerkingtreding en citeertitel

Toepasselijkheid voorafgaande beleidsregel

De [Beleidsregel prestatiebeschrijvingen voor ergotherapie](https://wetten.overheid.nl/jci1.3:c:BWBR0047864), met kenmerk BR/REG-24106, blijft van toepassing op besluiten en aangelegenheden die hun grondslag vinden in die beleidsregel en die betrekking hebben op de periode waarvoor die beleidsregel gold.
...
Deze beleidsregel wordt aangehaald als: Beleidsregel prestatiebeschrijvingen voor ergotherapie.
