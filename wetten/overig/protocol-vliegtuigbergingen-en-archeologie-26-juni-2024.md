...
Deze stappen zijn nader uitgewerkt in de procesbeschrijving in [Bijlage 1](https://wetten.overheid.nl/jci1.3:c:BWBR0049971&bijlage=1&z=2024-07-11&g=2024-07-11). Alle partijen streven ernaar dit proces met gepaste voortvarendheid te voltooien.
...
- f. digitale bronnen, zoals het Centraal archeologisch informatiesysteem (Archis) als bedoeld in [artikel 5.12 van de Erfgoedwet](https://wetten.overheid.nl/jci1.3:c:BWBR0037521&artikel=5.12), het Portable Antiquities of the Netherlands-project (PAN) en lokale archeologische verwachtingskaarten;
...
- 4). Vanwege de aard van de bergingswerkzaamheden, zal eventueel veldonderzoek het karakter hebben van een archeologische begeleiding7Conform het desbetreffende protocol in de Kwaliteitsnorm Nederlandse Archeologie dat vigerend is ten tijde van het opstellen van het Programma van Eisen voor het uit te voeren onderzoek. Momenteel betreft dit Protocol 4004 Opgraving – variant Archeologische Begeleiding.. Er kan ook worden aanbevolen om geen archeologisch veldonderzoek te verrichten.
