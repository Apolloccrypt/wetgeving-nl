...
- c. overeenkomstig de eisen, opgenomen in de [Archiefregeling](https://wetten.overheid.nl/jci1.3:c:BWBR0027041) 2009 (Stcrt. 2010, 70); en

- d. met inachtneming van de waarde en het belang, bedoeld in [artikel 2, eerste lid, onderdeel c onderscheidenlijk d, van het Archiefbesluit 1995](https://wetten.overheid.nl/jci1.3:c:BWBR0007748&artikel=2).
...
De originele analoge stukken die zijn gedigitaliseerd worden nu tijdelijk in archiefdozen bewaard in het depot in de Hoftoren. De originele, analoge documenten gelden in de huidige situatie nog steeds als archiefbescheiden in de zin van de [Archiefwet](https://wetten.overheid.nl/jci1.3:c:BWBR0007376). Dit betekent dat de Rijksdienst te maken heeft met een dubbele beheerstaak: zowel het beheer van de analoge originelen als het beheer van de digitale originelen. Deze dubbele beheerstaak is bezwaarlijk.

[Artikel 7 van de Archiefwet 1995](https://wetten.overheid.nl/jci1.3:c:BWBR0007376&artikel=7), biedt de zorgdrager de mogelijkheid een besluit tot vervanging van archiefbescheiden te nemen, rekening houdend met de voorwaarden gesteld in de [artikelen 2](https://wetten.overheid.nl/jci1.3:c:BWBR0001882&artikel=2), [6](https://wetten.overheid.nl/jci1.3:c:BWBR0001882&artikel=6) en [8 van het Archiefbesluit 1995](https://wetten.overheid.nl/jci1.3:c:BWBR0007748&artikel=8) en [hoofdstuk 3A van de Archiefregeling](https://wetten.overheid.nl/jci1.3:c:BWBR0027041&hoofdstuk=3a). Onder het besluit tot digitale vervanging archieven Rijksdienst voor het Cultureel Erfgoed vallen alle via scanning gedigitaliseerde en in het DMS van de RCE opgenomen documenten die aan deze voorwaarden voldoen.
...
In het [organisatie- en mandaatbesluit OCW](https://wetten.overheid.nl/jci1.3:c:BWBR0023543) is de organisatie van het ministerie beschreven. Voor een up to date weergave van de organisatie, het organisatie- en mandaatbesluit en het organigram wordt verwezen naar het intranet / internet van OCW.
...
De minister van OCW heeft de verantwoordelijkheid voor de uitvoering van het beheer van de archiefbescheiden geregeld in de [Regeling Informatiebeheer OCW 2013](https://wetten.overheid.nl/jci1.3:c:BWBR0033170).

De [Regeling Informatiebeheer OCW](https://wetten.overheid.nl/jci1.3:c:BWBR0033170) is als **bijlage 2** bij dit handboek gevoegd.
...
### Bijlage 2:. [Regeling Informatiebeheer OCW](https://wetten.overheid.nl/jci1.3:c:BWBR0033170)

### [Regeling Informatiebeheer OCW 2013](https://wetten.overheid.nl/jci1.3:c:BWBR0033170)
...
De [Regeling informatiebeheer](https://wetten.overheid.nl/jci1.3:c:BWBR0033170) is van toepassing op het beheer van alle informatie van concern OCW.
...
De [regeling Informatiebeheer OCW van 16 februari 2009](https://wetten.overheid.nl/jci1.3:c:BWBR0025449), nr. WJZ/98508 (8222) wordt ingetrokken.
...
[Artikel 14 van het Archiefbesluit 1995](https://wetten.overheid.nl/jci1.3:c:BWBR0007748&artikel=14) verplicht zorgdragers in de zin van de [artikelen 23. eerste lid](https://wetten.overheid.nl/jci1.3:c:BWBR0007376&artikel=23), en [41, eerste lid, van de Archiefwet 1995](https://wetten.overheid.nl/jci1.3:c:BWBR0007376&artikel=41) tot het vaststellen van beheersregels ten aanzien van hun archiefbescheiden. Deze regeling, die de [Regeling Informatiebeheer uit 2009](https://wetten.overheid.nl/jci1.3:c:BWBR0025449) vervangt, strekt daartoe. Tot vervanging van de Regeling Informatiebeheer wordt overgegaan vanwege:
...
Ten opzichte van de vorige [regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0025449) gaat deze regeling primair uit van een digitale informatiehuishouding en de daarmee gepaarde veranderingen (op het vakgebied IV) bij OCW. In de vigerende archiefwetgeving is sprake van bijvoorbeeld de termen archiefbescheiden, archief, archiefvormend orgaan en archiefbeheer. Echter, de steeds verder gaande digitalisering brengt veranderingen met zich mee die ertoe nopen om de terminologie in deze [regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0033170) aan te passen. Zo is in deze regeling:

In onderstaand schema is de eindsituatie van deze transitie weergegeven:

Door digitalisering zullen niet de verantwoordelijkheden, maar wel de huidige taken en rollen ten aanzien van de informatiehuishouding wijzigen en op een andere wijze belegd moeten worden. In deze [regeling](https://wetten.overheid.nl/jci1.3:c:BWBR0033170) is bijvoorbeeld nog sprake van verschillende archiefvormende onderdelen. Na volledige digitalisering zal er nog maar één archiefvormend onderdeel zijn, namelijk Concern OCW.
...
Overheidsorganisaties zijn op grond van de [Archiefregeling](https://wetten.overheid.nl/jci1.3:c:BWBR0027041) verplicht op basis van de NEN-ISO 23081 een overzicht vast te stellen, waarin ze aangeven welke metagegevens voor de eigen organisatie minimaal nodig zijn en hoe deze worden vastgelegd. Dat doen we door afspraken over welke metagegevens nodig zijn en over de manier waarop die gegevens binnen de Rijksoverheid worden vastgelegd.
