...
3. Indien het subsidieplafond na toepassing van het bepaalde in lid 2 nog steeds wordt overschreden, worden alle andere te verlenen subsidiebedragen verlaagd met maximaal 20% tot het niveau waarbinnen het totaal beschikbare bedrag volledig kan worden benut.
...
- c. indien voor een concert of voorstelling een evenementenvergunning vereist was.

5. Het subsidie kan (gedeeltelijk) worden geweigerd indien het Fonds constateert dat de aanvrager in de afgelopen periode vergelijkbare subsidies van het Fonds Podiumkunsten niet heeft gebruikt om zzp’ers en andere betrokkenen door te betalen conform overeengekomen afspraken.
...
- a. aannemelijk is dat het verlies dat als gevolg van de covid19-maatregelen is geleden aanzienlijk afwijkt van de uitkomst van de regel als bedoeld in het eerste lid;

- b. voor de betreffende concerten en voorstellingen reeds een subsidie is verleend op grond van de [Regeling tijdelijke ondersteuning programmering middelgrote en kleine podia Fonds Podiumkunsten](https://wetten.overheid.nl/jci1.3:c:BWBR0044211);
