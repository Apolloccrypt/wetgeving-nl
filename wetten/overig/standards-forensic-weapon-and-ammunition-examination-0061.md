...
Furthermore the Board determines the assessment procedure. This procedure is described in [Part IV](https://wetten.overheid.nl/jci1.3:c:BWBR0039081&deel=IV&z=2016-12-12&g=2016-12-12) of these Standards.
...
The revision history starts with version 1.0 as the first formally approved version. Substantive changes made are briefly described in the revision history ([Annex C](https://wetten.overheid.nl/jci1.3:c:BWBR0039081&bijlage=C&z=2016-12-12&g=2016-12-12)). This makes it possible to trace at all times which Standards are valid at any given moment.
