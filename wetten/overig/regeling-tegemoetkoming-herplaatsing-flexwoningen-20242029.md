...
2. De investeerder maakt aanspraak op vaststelling van de subsidie, indien de flexwoning na de termijn, bedoeld in [artikel 15, eerste of tweede lid](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=3&artikel=15&z=2024-01-01&g=2024-01-01), niet op een nieuwe locatie kan worden geëxploiteerd of om andere redenen met verlies moet worden verkocht, mits wordt voldaan aan de voorwaarden, bedoeld in [artikel 15](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=3&artikel=15&z=2024-01-01&g=2024-01-01).

3. De hoogte van de compensatie wordt berekend op de wijze, bedoeld in [artikel 18](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=3&artikel=18&z=2024-01-01&g=2024-01-01).
...
7. De administratie, de jaarrekeningen en de jaarverslagen van de investeerder worden met inachtneming van [artikel 25b, eerste lid, van de Mededingingswet](https://wetten.overheid.nl/jci1.3:c:BWBR0008691&artikel=25b) ingericht.
...
2. Een flexwoning dient op het moment van eerste plaatsing te voldoen aan de voorschriften van het [Besluit bouwwerken leefomgeving](https://wetten.overheid.nl/jci1.3:c:BWBR0041297).

3. In aanvulling op het tweede lid dient een flexwoning die onder de categorie van tijdelijke bouwwerken uit het [Besluit bouwwerken leefomgeving](https://wetten.overheid.nl/jci1.3:c:BWBR0041297) valt aan de volgende aanvullende technische voorschriften te voldoen:
...
- b. een flexwoning is bijna energiezuinig en voldoet aan de voorschriften uit [artikelen 4.148](https://wetten.overheid.nl/jci1.3:c:BWBR0041297&artikel=4.148) en [4.149 van het Besluit bouwwerken leefomgeving](https://wetten.overheid.nl/jci1.3:c:BWBR0041297&artikel=4.149), waarbij de flexwoning dient te worden aangemerkt als een ‘andere woonfunctie’;

- c. een flexwoning heeft een waarde voor oververhitting en voldoet aan [artikel 4.149b van het Besluit bouwwerken leefomgeving](https://wetten.overheid.nl/jci1.3:c:BWBR0041297&artikel=4.149b), waarbij de flexwoning dient te worden aangemerkt als een ‘niet in een woongebouw gelegen woonfunctie’;
...
4. In aanvulling op het tweede lid dient een flexwoning die onder de categorie van nieuwbouw uit het [Besluit bouwwerken leefomgeving](https://wetten.overheid.nl/jci1.3:c:BWBR0041297) valt aan de volgende aanvullende technische eisen te voldoen:
...
- a. het besluit van het college, bedoeld in [artikel 5, eerste lid, onderdeel a](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=2&artikel=5&z=2024-01-01&g=2024-01-01);
...
- a. niet is voldaan aan het doel en activiteiten, bedoeld in [artikel 2](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=1&artikel=2&z=2024-01-01&g=2024-01-01);

- b. de verlening leidt tot een overschrijding van het plafond, bedoeld in [artikel 4](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=1&artikel=4&z=2024-01-01&g=2024-01-01);

- c. niet is voldaan aan de voorwaarden, bedoeld in [artikel 5](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=2&artikel=5&z=2024-01-01&g=2024-01-01); of
...
- c. het besluit van de gemeente, bedoeld in [artikel 5, eerste lid, onderdeel a](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=2&artikel=5&z=2024-01-01&g=2024-01-01), ook van toepassing is bij verkoop van de flexwoning.
...
2. In afwijking van het eerste lid, kan de aanvraag voor een flexwoning die voldoet aan de technische voorschriften, bedoeld in [artikel 5, tweede en vierde lid](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=2&artikel=5&z=2024-01-01&g=2024-01-01), worden gedaan nadat minimaal 10 jaar en maximaal 30 jaar zijn verstreken, gerekend vanaf de dag na de verzenddatum van de subsidieverlening.
...
- a. de investeerder dient minimaal 24 maanden voordat de termijn, bedoeld in [artikel 15, eerste of tweede lid](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=3&artikel=15&z=2024-01-01&g=2024-01-01), afloopt aan de Minister schriftelijk door te geven wanneer de flexwoning niet op de huidige locatie kan blijven staan;
...
- c. een beschrijving hoe wordt voldaan aan de voorwaarden, bedoeld in [artikel 15](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=3&artikel=15&z=2024-01-01&g=2024-01-01);
...
2. Na afloop van de termijn, bedoeld in [artikel 15, eerste of tweede lid](https://wetten.overheid.nl/jci1.3:c:BWBR0049080&hoofdstuk=3&artikel=15&z=2024-01-01&g=2024-01-01), neemt de Minister ambtshalve een beschikking waarin de subsidie op nihil wordt vastgesteld.
