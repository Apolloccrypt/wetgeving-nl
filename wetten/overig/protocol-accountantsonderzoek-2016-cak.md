...
Het ministerie van Volksgezondheid, Welzijn en Sport (VWS) en de Nederlandse Zorgautoriteit (NZa) hebben in het [Model Jaarverslaggeving 2016 CAK](onbekend) voorschriften opgenomen voor de inrichting van de verantwoordingsdocumenten 2016 van het CAK. Het model bevat modellen waarmee het CAK zijn verantwoordingsdocumenten moet inrichten.
...
Bij deze opdracht vormen het [Model Jaarverslaggeving 2016 CAK](onbekend) en het Protocol Accountantsonderzoek 2016 CAK het uitgangspunt. VWS en de NZa voorzien het CAK en een externe accountant van een exemplaar van het model en het protocol.
...
Het financieel verslag van het CAK bevat een financiële verantwoording over de uitvoering van de wet volgens het [Model Jaarverslaggeving 2016 CAK](onbekend). Het CAK verantwoord zich over de uitvoering van de wet middels:
...
In de bestuurlijke verantwoording legt het CAK volgens het [Model Jaarverslaggeving 2016 CAK](onbekend) verantwoording af over:
...
In de bestuurlijke verantwoording wordt gebruik gemaakt van de matrix bestuurlijke verantwoording VWS en NZa (zie paragraaf 4.2.3 van het [Model Jaarverslaggeving 2016 CAK](onbekend)). In deze matrix legt het CAK verantwoording af over de geldstromen:
...
Het uitvoeringsverslag (hierna aangeduid als: directieverslag) wordt toegevoegd aan de jaarrekening en wordt ingericht conform [Titel 9 van Boek 2 van het Burgerlijk Wetboek](https://wetten.overheid.nl/jci1.3:c:BWBR0003045&titeldeel=9). In dit directieverslag legt het CAK verantwoording af volgens het [Model Jaarverslaggeving 2016 CAK](onbekend). Deze bevat minimaal:
...
Met getrouw beeld wordt in dit protocol bedoeld het voldoen aan de geldende wet- en regelgeving zoals opgenomen in het [Model Jaarverslaggeving 2016 CAK](onbekend). Voor het onderzoek naar de getrouwheid van de jaarrekening en de rechtmatigheidsverantwoording zijn in dit protocol geen nadere voorschriften opgenomen. Deze werkzaamheden moeten plaatsvinden in overeenstemming met de geldende beroepsvoorschriften van de Nederlandse Beroepsorganisatie van Accountants (NBA), waaronder de [Verordening gedrags- en beroepsregels accountants](https://wetten.overheid.nl/jci1.3:c:BWBR0034635) (VGBA) en de Nadere Voorschriften Controle- en Overige Standaarden (NV COS).
...
In het [Model Jaarverslaggeving 2016 CAK](onbekend) is het rechtmatigheidsbegrip in detail uitgewerkt. Hierbij wordt onderscheid gemaakt tussen financiële en procedurele rechtmatigheid en tussen directe en gebruikers-verantwoordelijkheid. Het model geeft ook aan welke randvoorwaarden bij de invulling van het rechtmatigheidsbegrip van toepassing zijn. Een externe accountant hanteert de begripsomschrijvingen uit het Model Jaarverslaggeving 2016 CAK als uitgangspunt voor het rechtmatigheidsonderzoek dat hij uitvoert.
...
In het [Model Jaarverslaggeving 2016 CAK](onbekend) zijn de taken van het CAK beschreven.
...
Specifiek moet een externe accountant aandacht besteden aan (gewijzigde) wet- en regelgeving en de implementatie hiervan binnen het CAK zoals vastgelegd in het [Model Jaarverslaggeving 2016 CAK](onbekend). Voor het verantwoordingsjaar 2016 moet onder andere aandacht besteed worden aan de afbouw van de ouderbijdragen op basis van de [Jeugdwet](https://wetten.overheid.nl/jci1.3:c:BWBR0034925).

### 4.2.3. Taken onder toezicht van VWS

### 4.2.3.1. Beheerskosten van het CAK

De externe accountant hanteert voor zijn onderzoek naar de beheerskosten van het CAK en de hiermee samenhangende posten in de jaarrekening het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de interest geldmiddelen beheerskosten en de hiermee samenhangende posten in de jaarrekening het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
De concrete invulling van het begrip rechtmatigheid voor deze taak is weergegeven in hoofdstuk 4 van het [Model Jaarverslaggeving 2016 CAK](onbekend).

Een externe accountant stelt vast dat het CAK de aanspraken op de tegemoetkoming [Wtcg](https://wetten.overheid.nl/jci1.3:c:BWBR0025003) volledig, juist en tijdig heeft vastgesteld en uitbetaald, gegeven zijn verantwoordelijkheid zoals vastgelegd in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
### 4.2.3.4. Afdracht ouderbijdragen op basis van de [Jeugdwet](https://wetten.overheid.nl/jci1.3:c:BWBR0034925)
...
Een externe accountant hanteert voor zijn onderzoek naar de ouderbijdragen op basis van de [Jeugdwet](https://wetten.overheid.nl/jci1.3:c:BWBR0034925) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de betalingen van zorgaanspraken [AWBZ](https://wetten.overheid.nl/jci1.3:c:BWBR0002614) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de betalingen van zorgaanspraken [Wlz](https://wetten.overheid.nl/jci1.3:c:BWBR0035917) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
### 4.2.4.4. Betalingen [subsidieregeling eerstelijns verblijf](https://wetten.overheid.nl/jci1.3:c:BWBR0038571)
...
Een externe accountant hanteert voor zijn onderzoek naar de eigen bijdragen Zorg zonder Verblijf [AWBZ](https://wetten.overheid.nl/jci1.3:c:BWBR0002614) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de eigen bijdragen Zorg met Verblijf [AWBZ](https://wetten.overheid.nl/jci1.3:c:BWBR0002614) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de eigen bijdragen [Wlz](https://wetten.overheid.nl/jci1.3:c:BWBR0035917) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de eigen bijdragen [Wmo](https://wetten.overheid.nl/jci1.3:c:BWBR0035362) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
### 4.2.4.9. Ontvangen broninhouding [Wmo](https://wetten.overheid.nl/jci1.3:c:BWBR0035362) (beschermd wonen) via Zorginstituut Nederland
...
### 4.2.4.10. Interest geldmiddelen AFBZ, Flz en [Wmo](https://wetten.overheid.nl/jci1.3:c:BWBR0035362)

Een externe accountant hanteert voor zijn onderzoek naar de interest geldmiddelen AFBZ, Flz en [Wmo](https://wetten.overheid.nl/jci1.3:c:BWBR0035362) en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de uitkeringen CER en de hiermee samenhangende posten in het overzicht van activa en passiva het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Een externe accountant hanteert voor zijn onderzoek naar de interest geldmiddelen Zvf en de hiermee samenhangende posten het normenkader zoals uiteengezet in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
De minimumeisen voor het toetsingskader zijn nader uitgewerkt in het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Naar ons oordeel geeft de jaarrekening 2016 een getrouw beeld van de grootte en samenstelling van het vermogen van het CAK per 31 december 2016 en van het resultaat over 2016 in overeenstemming met [Titel 9 van Boek 2 van het Burgerlijk Wetboek](https://wetten.overheid.nl/jci1.3:c:BWBR0003045&titeldeel=9) en het [Model Jaarverslaggeving 2016 CAK](onbekend).
...
Verder vermelden wij dat het directieverslag, voor zover wij dat kunnen beoordelen, verenigbaar is met de jaarrekening van de raad van bestuur van het CAK en de jaarrekening en het directieverslag voldoen aan de inrichtingseisen zoals deze zijn opgenomen in het [Model Jaarverslaggeving 2016 CAK](onbekend).
