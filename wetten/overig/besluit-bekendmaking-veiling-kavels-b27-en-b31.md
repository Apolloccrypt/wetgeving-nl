...
## Bijlage 5. Toelichting behorende bij de ontwerpvergunningen digitale radio-omroep, als opgenomen in [bijlagen 3](https://wetten.overheid.nl/jci1.3:c:BWBR0038505&bijlage=3&z=2016-09-13&g=2016-09-13) en [4](https://wetten.overheid.nl/jci1.3:c:BWBR0038505&bijlage=4&z=2016-09-13&g=2016-09-13)
...
| Protectieverhouding exclusief statistische correctiefactor, dB | Protectieverhouding exclusief statistische correctiefactor, dB | Protectieverhouding exclusief statistische correctiefactor, dB |
| --- | --- | --- |
| 1e Nabuurkanaal | 2e Nabuurkanaal | 3e Nabuurkanaal |
| –35 | –40 | –45 |

| Buitenomgeving locatie waarschijnlijkheid % | Binnenshuis locatie waarschijnlijkheid % | Protectieverhouding inclusief statistische correctiefactor, dB | Protectieverhouding inclusief statistische correctiefactor, dB | Protectieverhouding inclusief statistische correctiefactor, dB |
| --- | --- | --- | --- | --- |
| Buitenomgeving locatie waarschijnlijkheid % | Binnenshuis locatie waarschijnlijkheid % | 1e Nabuur-kanaal | 2e Nabuurkanaal | 3e Nabuurkanaal |
| > 99 | 95 | –23 | –28 | –33 |
...
In artikel 3, eerste en tweede lid, is geregeld dat de overeenkomst, bedoeld in [artikel 3.21 van de Telecommunicatiewet](https://wetten.overheid.nl/jci1.3:c:BWBR0009950&artikel=3.21), (schriftelijk) dient te worden aangegaan en dat een afschift hiervan en de wijzigingen daarop onverwijld aan de minister dient/dienen te worden verstrekt.
