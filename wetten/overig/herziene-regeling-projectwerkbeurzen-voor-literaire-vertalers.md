...
- 2.3 Verlening van een projectwerkbeurs is gebonden aan een door het bestuur vast te stellen *inkomensgrens*. Het belastbaar verzamelinkomen in het jaar waarin (voorschotten van) een werkbeurs worden opgenomen, mag niet hoger zijn dan de vastgestelde inkomensgrens (zie: ook hierna onder [6.6](https://wetten.overheid.nl/BWBR0027430) en [9](https://wetten.overheid.nl/BWBR0027430)). De hoogte van de inkomensgrens wordt aan het begin van het jaar bekend gemaakt op de website van het Nederlands Letterenfonds, afdeling Huddestraat: www.fondsvoordeletteren.nl .
...
- 3.4 De vertaler ontvangt voor het vertaalproject een redelijk honorarium van de uitgeverij.
   ...
   - 3.4.1. Voor de vertaling dient een contract te zijn of te worden afgesloten als vermeld onder [2.2.1d](https://wetten.overheid.nl/BWBR0027430).
...
Een aanvraag die niet voldoet aan het gestelde onder [1](https://wetten.overheid.nl/BWBR0027430),[2](https://wetten.overheid.nl/BWBR0027430) of [3](https://wetten.overheid.nl/BWBR0027430) wordt afgewezen.
...
- 8.3 Beleid:
   ...
   - 8.3.4 Wanneer een aanvraag inhoudelijk positief wordt beoordeeld en uitsluitend op formele gronden (bijv. de overschrijding van het subsidieplafond als bedoeld in [12](https://wetten.overheid.nl/BWBR0027430) of het niet tijdig kunnen overleggen van het contract) wordt afgewezen, dan wordt de aanvraag – mits er een contract is – in beginsel doorgeschoven naar de volgende behandelronde.
...
Indien de toepassing van deze regeling, gezien het doel en strekking van deze regeling leidt tot onbillijkheden van overwegende aard kan het bestuur besluiten tot afwijking van het bepaalde onder [4](https://wetten.overheid.nl/BWBR0027430).
...
Deze regeling treedt in werking met ingang van 21 juli 2009. Met deze datum vervallen de [Regeling Projectwerkbeurzen voor literaire vertalers](https://wetten.overheid.nl/jci1.3:c:BWBR0012123) en de [Regeling stimuleringssubsidies vertaald literair werk 2005–2009](https://wetten.overheid.nl/jci1.3:c:BWBR0018250).
