...
2. Het percentage dat het Mondriaan Fonds maximaal kan bijdragen wordt op de website van het Mondriaan Fonds bekend gemaakt.

3. Een bijdrage kan worden verstrekt in de vorm van:

- a. Een vaste bijdrage voor een werkperiode in binnen- of buitenland, variërend van 1 tot maximaal 6 maanden. Op de website van het Mondriaan Fonds wordt het standaard bedrag bekend gemaakt.
...
2. De bijdrage kan niet worden aangevraagd voor televisie- en filmproducties.

3. Musea, kunstpodia en erfgoedinstellingen kunnen uitsluitend een bijdrage aanvragen voor een op zichzelf staande uiting rond beeldende kunst. Het project mag niet verbonden zijn met een al bestaande activiteit van de aanvrager (bijvoorbeeld een artikel of publicatie bij een tentoonstelling).
...
- b. Kwaliteit werkplan;

- c. Beoogde impact;

- d. Kwaliteit presentatieplan;

- e. Innovatieve kwaliteit.

2. Indien er sprake is van een samenwerking wordt er beoordeeld of de samenwerking van meerwaarde is voor het project.
