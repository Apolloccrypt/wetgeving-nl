...
Met de [Wet op het Hoger Onderwijs en Wetenschappelijk Onderzoek](https://wetten.overheid.nl/jci1.3:c:BWBR0005682) (WHW) van 8 oktober 1992 (Stb. 1992, 593) heeft de KNAW in 1993 rechtspersoonlijkheid gekregen. Deze rechtspersoonlijkheid sui generis, dat wil zeggen rechtstreeks voortvloeiend uit een wet, is opgenomen in [artikel 1.16 van de WHW](https://wetten.overheid.nl/jci1.3:c:BWBR0005682&artikel=1.16). De KNAW is vanaf dat moment een rechtspersoon met wettelijke taak. Met de instelling krachtens publiekrecht, is de KNAW tevens een bestuursorgaan overeenkomstig de [Algemene wet bestuursrecht](https://wetten.overheid.nl/jci1.3:c:BWBR0005537). Omdat de KNAW niet is bekleed met openbaar gezag, is zij geen ZBO zoals gedefinieerd in de Kaderwet zelfstandige bestuursorganen. In de Wet op het Hoger onderwijs en Wetenschappelijk onderzoek (WHW) is het doel van de KNAW vastgelegd in het eerste lid van [artikel 1.5](https://wetten.overheid.nl/jci1.3:c:BWBR0005682&artikel=1.5) (WHW, Stb. 1992, nr. 593):
...
### 2.3.5. Onderzoeksorganisatie

### 2.3.5.1. Onderzoeksorganisatie: Algemeen beleid

### 2.3.5.2. Bureau voor Bibliografie voor de Neerlandistiek (BBN)

### 2.3.5.3. Bureau Short Title Catalogue Nederland (STCN)

### 2.3.5.4. Bureau Basisvoorziening Tekstedities (BBT)

### 2.3.5.5. Bibliotheek van de KNAW

### 2.3.5.6. Centraal Bureau voor Schimmelcultures (CBS)

### 2.3.5.7. Fryske Akademy

### 2.3.5.8. Constantijn Huygens Intituut voor tekstedities en intellectuele geschiedenis (CHI)

### 2.3.5.9. Grotius Instituut

### 2.3.5.10. Hubrecht Instituut

### 2.3.5.11. Interuniversitair Cardiologisch Instituut Nederland (ICIN)

### 2.3.5.12. Internationaal Instituut voor Sociale Geschiedenis (IISG)

### 2.3.5.13. Interuniversitair Oogheelkundig Instituut (IOI)

### 2.3.5.14. Koninklijk Instituut voor Taal-, Land- en Volkenkunde (KITLV)

### 2.3.5.15. J. Meertens-Instituut (PJMI)

### 2.3.5.16. Nederlands Historisch Genootschap (NHG)

### 2.3.5.17. Netherlands Institute for Advanced Study in the Humanities and Social Sciences (NIAS)

### 2.3.5.18. Nederlands Instituut voor Hersenonderzoek (NIH)

### 2.3.5.19. Nederlands Instituut voor Oecologisch Onderzoek (NIOO)

### 2.3.5.20. Nederlandse Organisatie van Technologisch Aspectenonderzoek (NOTA)

### 2.3.5.21. Roosevelt Study Center (RSC)

### 2.3.5.22. Sociaal Wetenschappelijk Informatie- en Documentatiecentrum (SWIDOC)

### 2.4. Oude toegangen op het archief
