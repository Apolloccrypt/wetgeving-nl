...
Bijlage behorende bij [artikel 1](https://wetten.overheid.nl/jci1.3:c:BWBR0047614&artikel=1&z=2026-01-06&g=2026-01-06) van de Regeling beoordelingskader doorstroomtoets PO.
...
Het CvTE beoordeelt ook de door de overheid aangeboden calamiteitentoets1[https://www.eerstekamer.nl/behandeling/20210907/gewijzigd_amendement_van_het_lid/document3/f=/vlmnj6ccx4n2.pdf](https://www.eerstekamer.nl/behandeling/20210907/gewijzigd_amendement_van_het_lid/document3/f%3D/vlmnj6ccx4n2.pdf). Vanwege de bijzondere aard van de calamiteitentoets, bestaat de jaarlijkse vaststelling slechts uit een inhoudelijke check op actualiteiten en de kalibratie. Indien de calamiteitentoets in enig jaar moet worden ingezet, wordt een nieuwe toets voor het daarop volgende jaar ontwikkeld. Deze moet dan opnieuw erkend te worden door het CvTE.
...
### 3.5. Toetsopgaven Nederlandse taal en Rekenen op niveau 1F en 2F/1S
...
Beslisregel: Om aan deze categorie kwaliteitseisen te voldoen, moeten alle vragen met JA worden beantwoord. In de toelichting wordt bij enkele kwaliteitseisen aangegeven waar een doorverwijzing naar [www.Rijksoverheid.nl](http://www.rijksoverheid.nl) voor een toets van een aanbieder die voorziet in die behoefte voldoende kan zijn.
...
Het aanbieden van een brailleversie van de doorstroomtoets is facultatief. Wel moeten toetsaanbieders leerlingen met die behoefte in de verantwoordingsdocumenten en handleiding voor de afnemer doorverwijzen naar [www.Rijksoverheid.nl](http://www.rijksoverheid.nl/) voor een toets van een aanbieder die voorziet in die behoefte.
...
**Toelichting LL1.b**: De aanbieder levert bijvoorbeeld (op bestelling) een aangepaste toets indien de toets gebruikmaakt van functioneel geluid (zoals bijvoorbeeld bij dictee-opgaven). Indien een aanbieder hier niet in kan voorzien, moet deze de school in de verantwoordingsdocumenten en handleiding voor de afnemer verwijzen naar [www.Rijksoverheid.nl](http://www.rijksoverheid.nl/) waar is aangegeven welke toets van welke aanbieder voorziet in die behoefte.
...
### 1.4.3. Optioneel: het aanleveren van data t.b.v. landelijke normering
...
### 3.3.1. Wettelijk verplicht domein: Lezen

### 3.3.1.1. Domein Lezen

### 3.3.1.2. Subdomein Zakelijke Teksten

### 3.3.1.3. Subdomein Fictionele, narratieve en literaire teksten

### 3.3.2. Wettelijk verplicht subdomein: Taalverzorging

Taken:

### 3.3.4. Optioneel domein: Mondelinge taalvaardigheid

### Kwaliteitseisen mondelinge taalvaardigheid via indirecte meting

### Kwaliteitseisen mondelinge taalvaardigheid via directe meting

### 3.3.5. Optioneel subdomein: Begrippenlijst
