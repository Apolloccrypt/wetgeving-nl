---
title: "Tijdelijke experimentenregeling nieuwe stembiljetten"
identifier: "BWBR0049303"
categorie: "Overig"
publicatiedatum: 2025-10-01
laatste_update: 2025-10-01
status: geldig
bron: "https://wetten.overheid.nl/BWBR0049303"
---
...
## Bijlage. bij [artikel 1](https://wetten.overheid.nl/jci1.3:c:BWBR0049303&artikel=1&z=2025-10-01&g=2025-10-01) van de Tijdelijke experimentenregeling nieuwe stembiljetten
...
(Voorzijde) 1Het stembiljet wordt in kleur gedrukt. Het stembiljet wordt vanuit het midden opgebouwd, zodat er ook bij weinig lijsten geen grote witruimte tussen de aanduidingen van de lijsten en kandidaatnummers is.,2Tot en met 28 lijsten staan alle lijsten boven de horizontale vouw op het stembiljet. Bij 29 of meer lijsten, wordt een stembiljet gehanteerd waarbij de lijsten boven en onder de vouw staan. Op de vouw in het midden komt geen tekst. In de specificaties staan de precieze afstanden.

Bovenaan het stembiljet komt te staan ‘Stembiljet voor de verkiezing van de leden van de Tweede Kamer der Staten-Generaal/Eerste Kamer der Staten-Generaal/provinciale staten van ...../ het algemeen bestuur van het waterschap ..../ de raad van de gemeente ...../ de eilandsraad van het openbaar lichaam ...../ het kiescollege van het openbaar lichaam ...../ het Europees Parlement ..... [in kieskring ..... (.....) op ...’.3Alleen op te nemen, indien het een verkiezing betreft van de leden van de Tweede Kamer of van provinciale staten van een provincie die uit meer dan één kieskring bestaat. Achter ‘kieskring’ het nummer en tussen haakjes de naam van de gemeente waar het hoofdstembureau is gevestigd.

Op de bovenste helft van het stembiljet staan de lijsten (partijen) die aan de verkiezing deelnemen.4De in de kieskring deelnemende lijsten worden in twee kolommen weergegeven, waarbij van links naar rechts steeds het logo, stemvakje, lijstnummer, de aanduiding van de partij en een icoon met daarin een cijfer dat correspondeert met het aantal kandidaten op elke lijst worden afgebeeld. Bij een even aantal lijsten worden de lijsten in twee gelijke kolommen weergegeven. Bij een oneven aantal lijsten, bevat de linker kolom de aanduiding van één partij meer. De ordening van partijen gaat van boven naar beneden.,5In het geval er een blanco lijst op het stembiljet staat, dat wil zeggen een lijst waarboven géén aanduiding van een politieke groepering staat, komt op het stembiljet op de plaats voor de aanduiding van een politieke groepering de tekst te staan: ‘Lijst met lijstnummer [lijstnummer]’. De aanduiding voor de blanco lijst wordt cursief en niet dikgedrukt weergegeven. In het kader boven de partijen staat de tekst: ‘Kies één partij’.

Op de onderste helft staan de nummers van de kandidaten op de lijsten.De kandidaatnummers op de onderste helft worden weergegeven van links naar rechts, waarbij rijen van tien worden gemaakt. Het stemvakje wordt voor het kandidaatnummer geplaatst. Er staan niet meer kandidaatnummers op het stembiljet dan het hoogste aantal kandidaten dat in de kieskring op enige lijst voor de betreffende verkiezing voorkomt.
...
**Kiezershandleiding voor experimenten met een nieuw stembiljet**
