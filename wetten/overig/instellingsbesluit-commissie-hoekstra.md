...
– dat ingevolge de [Aanpassingswet invoering bachelor-masterstructuur](https://wetten.overheid.nl/jci1.3:c:BWBR0017830) is komen te gelden dat voor toetreding tot de juridische beroepen (rechterlijke macht, advocatuur en notariaat) de titel meester in de rechten moet zijn verkregen of in het wetenschappelijk onderwijs een combinatie van zowel de graad van bachelor (wo-bachelor), als die van master (wo-master) in het recht moet zijn behaald;
