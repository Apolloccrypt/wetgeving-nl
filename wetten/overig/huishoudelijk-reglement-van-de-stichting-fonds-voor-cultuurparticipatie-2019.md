...
- b. Indien unanimiteit niet haalbaar blijkt en de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0005904), de statuten van de stichting of dit huishoudelijk reglement geen grotere meerderheid voorschrijven, worden besluiten van de raad van toezicht genomen bij meerderheid van de uitgebrachte stemmen. Bij staking van stemmen wordt de besluitvorming opgeschort, tenzij dit naar oordeel van de voorzitter niet in het belang van de organisatie is, in dat geval is de stem van de voorzitter doorslaggevend.
...
2. In alle gevallen waarin de [wet](https://wetten.overheid.nl/jci1.3:c:BWBR0005904), de statuten of dit reglement, het [Algemeen Subsidiereglement](https://wetten.overheid.nl/jci1.3:c:BWBR0039127) of de deelreglementen niet voorzien, beslist het bestuur.
