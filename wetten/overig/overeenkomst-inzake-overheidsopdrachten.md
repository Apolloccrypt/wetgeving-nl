...
categorie: "Overig"
soort: "verdrag"
publicatiedatum: 1996-10-25
laatste_update: 2014-07-04
status: geldig
toestand: 2014-07-04
...
- b) Committee means the Committee on Government Procurement established by [Article XXI:1](https://wetten.overheid.nl/BWBV0001159);
...
- o) procuring entity means an entity covered under a Party’s [Annex 1](https://wetten.overheid.nl/BWBV0001159), [2](https://wetten.overheid.nl/BWBV0001159) or [3 to Appendix I](https://wetten.overheid.nl/BWBV0001159);
...
- a) of goods, services, or any combination thereof:
   ...
   - (i) as specified in each Party’s annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159); and
...
- c) for which the value, as estimated in accordance with paragraphs 6 through 8, equals or exceeds the relevant threshold specified in a Party’s annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159), at the time of publication of a notice in accordance with [Article VII](https://wetten.overheid.nl/BWBV0001159);

- d) by a procuring entity; and

- e) that is not otherwise excluded from coverage in paragraph 3 or a Party’s annexes to Appendix I.

3. Except where provided otherwise in a Party’s annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159), this Agreement does not apply to:
...
4. Each Party shall specify the following information in its annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159):

- a) in [Annex 1](https://wetten.overheid.nl/BWBV0001159), the central government entities whose procurement is covered by this Agreement;

- b) in [Annex 2](https://wetten.overheid.nl/BWBV0001159), the sub-central government entities whose procurement is covered by this Agreement;

- c) in [Annex 3](https://wetten.overheid.nl/BWBV0001159), all other entities whose procurement is covered by this Agreement;

- d) in [Annex 4](https://wetten.overheid.nl/BWBV0001159), the goods covered by this Agreement;

- e) in [Annex 5](https://wetten.overheid.nl/BWBV0001159), the services, other than construction services, covered by this Agreement;

- f) in [Annex 6](https://wetten.overheid.nl/BWBV0001159), the construction services covered by this Agreement; and

- g) in [Annex 7](https://wetten.overheid.nl/BWBV0001159), any General Notes.

5. Where a procuring entity, in the context of covered procurement, requires persons not covered under a Party’s annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159) to procure in accordance with particular requirements, [Article IV](https://wetten.overheid.nl/BWBV0001159) shall apply *mutatis mutandis* to such requirements.
...
2. Upon accession by a developing country to this Agreement, each Party shall provide immediately to the goods, services and suppliers of that country the most favourable coverage that the Party provides under its annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159) to any other Party to this Agreement, subject to any terms negotiated between the Party and the developing country in order to maintain an appropriate balance of opportunities under this Agreement.

3. Based on its development needs, and with the agreement of the Parties, a developing country may adopt or maintain one or more of the following transitional measures, during a transition period and in accordance with a schedule, set out in its relevant annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159), and applied in a manner that does not discriminate among the other Parties:
...
4. In negotiations on accession to this Agreement, the Parties may agree to the delayed application of any specific obligation in this Agreement, other than [Article IV:1(b)](https://wetten.overheid.nl/BWBV0001159), by the acceding developing country while that country implements the obligation. The implementation period shall be:
...
5. Any developing country that has negotiated an implementation period for an obligation under paragraph 4 shall list in its [Annex 7 to Appendix I](https://wetten.overheid.nl/BWBV0001159) the agreed implementation period, the specific obligation subject to the implementation period and any interim obligation with which it has agreed to comply during the implementation period.
...
- a) in [Appendix II](https://wetten.overheid.nl/BWBV0001159), the electronic or paper media in which the Party publishes the information described in paragraph 1;

- b) in [Appendix III](https://wetten.overheid.nl/BWBV0001159), the electronic or paper media in which the Party publishes the notices required by [Articles VII](https://wetten.overheid.nl/BWBV0001159), [IX:7](https://wetten.overheid.nl/BWBV0001159) and [XVI:2](https://wetten.overheid.nl/BWBV0001159); and

- c) in [Appendix IV](https://wetten.overheid.nl/BWBV0001159), the website address or addresses where the Party publishes:

   - (i) its procurement statistics pursuant to [Article XVI:5](https://wetten.overheid.nl/BWBV0001159); or

   - (ii) its notices concerning awarded contracts pursuant to [Article XVI:6](https://wetten.overheid.nl/BWBV0001159).

3. Each Party shall promptly notify the Committee of any modification to the Party’s information listed in [Appendix II](https://wetten.overheid.nl/BWBV0001159), [III](https://wetten.overheid.nl/BWBV0001159) or [IV](https://wetten.overheid.nl/BWBV0001159).

##### Article VII. Notices

Notice of Intended Procurement

1. For each covered procurement, a procuring entity shall publish a notice of intended procurement in the appropriate paper or electronic medium listed in [Appendix III](https://wetten.overheid.nl/BWBV0001159), except in the circumstances described in [Article XIII](https://wetten.overheid.nl/BWBV0001159). Such medium shall be widely disseminated and such notices shall remain readily accessible to the public, at least until expiration of the time-period indicated in the notice. The notices shall:

- a) for procuring entities covered under [Annex 1](https://wetten.overheid.nl/BWBV0001159), be accessible by electronic means free of charge through a single point of access, for at least any minimum period of time specified in [Appendix III](https://wetten.overheid.nl/BWBV0001159); and

- b) for procuring entities covered under [Annex 2](https://wetten.overheid.nl/BWBV0001159) or [3](https://wetten.overheid.nl/BWBV0001159), where accessible by electronic means, be provided, at least, through links in a gateway electronic site that is accessible free of charge.

Parties, including their procuring entities covered under [Annex 2](https://wetten.overheid.nl/BWBV0001159) or [3](https://wetten.overheid.nl/BWBV0001159), are encouraged to publish their notices by electronic means free of charge through a single point of access.
...
- k) where, pursuant to [Article IX](https://wetten.overheid.nl/BWBV0001159), a procuring entity intends to select a limited number of qualified suppliers to be invited to tender, the criteria that will be used to select them and, where applicable, any limitation on the number of suppliers that will be permitted to tender; and
...
- a) include in the notice of intended procurement at least the information specified in [Article VII:2(a), (b), (f), (g), (j), (k) and (l)](https://wetten.overheid.nl/BWBV0001159) and invite suppliers to submit a request for participation; and

- b) provide, by the commencement of the time-period for tendering, at least the information in [Article VII:2 (c), (d), (e), (h) and (i)](https://wetten.overheid.nl/BWBV0001159) to the qualified suppliers that it notifies as specified in [Article XI:3(b)](https://wetten.overheid.nl/BWBV0001159).
...
in the appropriate medium listed in [Appendix III](https://wetten.overheid.nl/BWBV0001159).
...
11. Where a supplier that is not included on a multi-use list submits a request for participation in a procurement based on a multi-use list and all required documents, within the time-period provided for in [Article XI:2](https://wetten.overheid.nl/BWBV0001159), a procuring entity shall examine the request. The procuring entity shall not exclude the supplier from consideration in respect of the procurement on the grounds that the entity has insufficient time to examine the request, unless, in exceptional cases, due to the complexity of the procurement, the entity is not able to complete the examination of the request within the time-period allowed for the submission of tenders.

Annex 2

Annex 3

12. A procuring entity covered under [Annex 2](https://wetten.overheid.nl/BWBV0001159) or [3](https://wetten.overheid.nl/BWBV0001159) may use a notice inviting suppliers to apply for inclusion on a multi-use list as a notice of intended procurement, provided that:

- a) the notice is published in accordance with paragraph 7 and includes the information required under paragraph 8, as much of the information required under [Article VII:2](https://wetten.overheid.nl/BWBV0001159) as is available and a statement that it constitutes a notice of intended procurement or that only the suppliers on the multi-use list will receive further notices of procurement covered by the multi-use list; and

- b) the entity promptly provides to suppliers that have expressed an interest in a given procurement to the entity, sufficient information to permit them to assess their interest in the procurement, including all remaining information required in [Article VII:2](https://wetten.overheid.nl/BWBV0001159), to the extent such information is available.

13. A procuring entity covered under [Annex 2](https://wetten.overheid.nl/BWBV0001159) or [3](https://wetten.overheid.nl/BWBV0001159) may allow a supplier that has applied for inclusion on a multi-use list in accordance with paragraph 10 to tender in a given procurement, where there is sufficient time for the procuring entity to examine whether the supplier satisfies the conditions for participation.
...
- a) the procuring entity has published a notice of planned procurement as described in [Article VII:4](https://wetten.overheid.nl/BWBV0001159) at least 40 days and not more than 12 months in advance of the publication of the notice of intended procurement, and the notice of planned procurement contains:
   ...
   - (v) as much of the information that is required for the notice of intended procurement under [Article VII:2](https://wetten.overheid.nl/BWBV0001159), as is available;
...
1. Provided that it does not use this provision for the purpose of avoiding competition among suppliers or in a manner that discriminates against suppliers of any other Party or protects domestic suppliers, a procuring entity may use limited tendering and may choose not to apply Articles VII through IX, [X (paragraphs 7 through 11)](https://wetten.overheid.nl/BWBV0001159), [XI](https://wetten.overheid.nl/BWBV0001159), [XII](https://wetten.overheid.nl/BWBV0001159), [XIV](https://wetten.overheid.nl/BWBV0001159) and [XV](https://wetten.overheid.nl/BWBV0001159) only under any of the following circumstances:

- a) where: provided that the requirements of the tender documentation are not substantially modified;
...
1. A procuring entity shall promptly inform participating suppliers of the entity’s contract award decisions and, on the request of a supplier, shall do so in writing. Subject to [paragraphs 2 and 3 of Article XVII](https://wetten.overheid.nl/BWBV0001159), a procuring entity shall, on request, provide an unsuccessful supplier with an explanation of the reasons why the entity did not select its tender and the relative advantages of the successful supplier’s tender.

Publication of Award Information

2. Not later than 72 days after the award of each contract covered by this Agreement, a procuring entity shall publish a notice in the appropriate paper or electronic medium listed in [Appendix III](https://wetten.overheid.nl/BWBV0001159). Where the entity publishes the notice only in an electronic medium, the information shall remain readily accessible for a reasonable period of time. The notice shall include at least the following information:
...
- f) the type of procurement method used, and in cases where limited tendering was used in accordance with [Article XIII](https://wetten.overheid.nl/BWBV0001159), a description of the circumstances justifying the use of limited tendering.
...
- a) the documentation and reports of tendering procedures and contract awards relating to covered procurement, including the reports required under [Article XIII](https://wetten.overheid.nl/BWBV0001159); and
...
- a) for [Annex 1](https://wetten.overheid.nl/BWBV0001159) procuring entities:
...
- b) for [Annex 2](https://wetten.overheid.nl/BWBV0001159) and [3](https://wetten.overheid.nl/BWBV0001159) procuring entities, the number and total value of contracts covered by this Agreement awarded by all such entities, broken down by Annex; and
...
1. A Party shall notify the Committee of any proposed rectification, transfer of an entity from one annex to another, withdrawal of an entity or other modification of its annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159) (any of which is hereinafter referred to as “modification”). The Party proposing the modification (hereinafter referred to as “modifying Party”) shall include in the notification:

- a) for any proposed withdrawal of an entity from its annexes to [Appendix I](https://wetten.overheid.nl/BWBV0001159) in exercise of its rights on the grounds that government control or influence over the entity’s covered procurement has been effectively eliminated, evidence of such elimination; or
...
it may, with a view to reaching a mutually satisfactory solution to the matter, have recourse to the provisions of the [Understanding on Rules and Procedures Governing the Settlement of Disputes](https://wetten.overheid.nl/jci1.3:c:BWBV0001160&bijlage=2) (hereinafter referred to as “the Dispute Settlement Understanding”).

3. The Dispute Settlement Understanding shall apply to consultations and the settlement of disputes under this Agreement, with the exception that, notwithstanding [paragraph 3 of Article 22 of the Dispute Settlement Understanding](https://wetten.overheid.nl/jci1.3:c:BWBV0001160&artikel=22), any dispute arising under any Agreement listed in Appendix 1 to the Dispute Settlement Understanding other than this Agreement shall not result in the suspension of concessions or other obligations under this Agreement, and any dispute arising under this Agreement shall not result in the suspension of concessions or other obligations under any other Agreement listed in Appendix 1 of the Dispute Settlement Understanding.
...
- b) inform the General Council of its activities, pursuant to [Article IV:8 of the Marrakesh Agreement Establishing the World Trade Organization](https://wetten.overheid.nl/jci1.3:c:BWBV0001160&artikel=IV) (hereinafter referred to as “[WTO Agreement](https://wetten.overheid.nl/jci1.3:c:BWBV0001160)”), and of developments relating to the implementation and operation of this Agreement.
...
1. This Agreement shall enter into force on 1 January 1996 for those governments1)For the purpose of this Agreement, the term “government” is deemed to include the competent authorities of the European Union. whose agreed coverage is contained in the Annexes of [Appendix I](https://wetten.overheid.nl/BWBV0001159) of this Agreement, and which have, by signature, accepted the Agreement on 15 April 1994, or have, by that date, signed the Agreement subject to ratification and have subsequently ratified the Agreement before 1 January 1996.
...
9. Following the conclusion of the work programme to harmonize rules of origin for goods being undertaken under the Agreement on Rules of Origin in [Annex 1A to the WTO Agreement](https://wetten.overheid.nl/BWBV0001160) and negotiations regarding trade in services, the Parties shall take the results of that work programme and those negotiations into account in amending [Article IV:5](https://wetten.overheid.nl/BWBV0001159), as appropriate.

10. Not later than the end of the fifth year from the date of entry into force of the Protocol Amending the Agreement on Government Procurement, the Committee shall examine the applicability of [Article XX:2(b)](https://wetten.overheid.nl/BWBV0001159).
...
17. This Agreement shall be deposited with the Director-General of the WTO, who shall promptly furnish to each Party a certified true copy of this Agreement, of each rectification or modification thereto pursuant to [Article XIX](https://wetten.overheid.nl/BWBV0001159) and of each amendment pursuant to paragraph 11, and a notification of each accession thereto pursuant to paragraph 2 and of each withdrawal pursuant to paragraphs 12 or 13.

Registration

18. This Agreement shall be registered in accordance with the provisions of [Article 102 of the Charter of the United Nations](https://wetten.overheid.nl/jci1.3:c:BWBV0004143&artikel=102).
