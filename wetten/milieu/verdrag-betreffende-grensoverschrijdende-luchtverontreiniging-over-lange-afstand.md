...
- (f) physico-chemical and biological data relating to the effects of long-range transboundary air pollution and the extent of the damage 1)The present Convention does not contain a rule on State liability as to damage. which these data indicate can be attributed to long-range transboundary air pollution;
