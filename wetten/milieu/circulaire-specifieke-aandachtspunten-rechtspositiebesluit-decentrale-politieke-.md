...
Er is op gewezen dat [artikel 4.3.2](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.2) niet is geformuleerd als een discretionaire bevoegdheid, een zogenaamde kan-bepaling, maar dwingend zou voorschrijven dat onder alle omstandigheden ICT-middelen ter beschikking moeten worden gesteld. Op zich is het juist dat de formulering dwingendrechtelijk is, maar zoals in de circulaire is beschreven bij de toelichting op dit artikel, is terbeschikkingstelling een fiscaal begrip. Voor die terbeschikkingstelling is bepalend het noodzakelijkheidscriterium: kan het digitaal gereedschap noodzakelijk worden geacht voor de vervulling van de functie? Indien het oordeel van het Dagelijks Bestuur is dat dit digitale gereedschap noodzakelijk is, dán is er geen discretionaire bevoegdheid meer en is terbeschikkingstelling verplicht. Het waterschap is dus niet op basis van deze dwingende formulering gehouden om altijd ICT-middelen te verstrekken aan alle ambtsdragers onder alle omstandigheden. Het gaat er juist om dat het waterschap de ICT belastingvrij ter beschikking moet stellen als die noodzakelijk wordt geacht voor het werk als politieke ambtsdrager. Het verstrekken is dan alleen niet verplicht als het niet noodzakelijk is.
...
Er is geen artikel in het [rechtspositiebesluit](https://wetten.overheid.nl/jci1.3:c:BWBR0041522) dat overname van ICT-bedrijfsmiddelen verbiedt. Echter, in de toelichting op het rechtspositiebesluit (2e alinea blz. 65 van Stb. 2018, 386) en de tekst in de [circulaire van 30 januari 2019](https://wetten.overheid.nl/jci1.3:c:BWBR0041882) (blz. 22) is wel als beleid uitgedragen dat die overname ongewenst is; om de daar aangegeven redenen.

Er is nog een reden. Het wel overnemen van ICT-bedrijfsmiddelen zou de consequentie hebben dat het waterschap zich niet houdt aan de door waterschappen zelf (mede) vastgestelde [Baseline Informatiebeveiliging Overheid (BIO)](https://wetten.overheid.nl/jci1.3:c:BWBR0042237). Deze geldt vanaf 1 januari 2019 en is gepubliceerd in de Staatscourant van 23 mei 2019, Stcrt. 26526. In die baseline wordt in control 8.1.4, die specifiek betrekking heeft op het teruggeven van bedrijfsmiddelen, het volgende gesteld: “Alle medewerkers en externe gebruikers moeten alle bedrijfsmiddelen van de organisatie die ze in hun bezit hebben bij beëindiging van hun dienstverband, contract of overeenkomst teruggeven”.
...
In het [rechtspositiebesluit](https://wetten.overheid.nl/jci1.3:c:BWBR0041522) wordt onderscheid gemaakt tussen zakelijk, bestuurlijk en privégebruik van de door het waterschap ter beschikking gestelde auto.
...
Of een voorzitter, lid van het dagelijks bestuur, lid van het algemeen bestuur of commissielid een bepaalde reis aanmerkt als een dienstreis, is de eigen verantwoordelijkheid van de individuele politieke ambtsdrager. Betrokkene dient te motiveren waarom hij of zij deze reizen declareert als zijnde reizen ten behoeve van de functie. Betrokkene staat voor zijn of haar declaratie. Natuurlijk kunnen declaraties gebundeld worden aangeleverd om de administratieve afhandeling te vereenvoudigen, maar dit doet niet af aan de motiveringsplicht van betrokkene per reisbeweging. Ook het feit dat er geen gezagsverhouding bestaat tussen waterschap en leden van het algemeen bestuur of commissieleden, doet er niet aan af dat dit lid op grond van de rechtspositionele regels moet aantonen dat de gedeclareerde reiskosten gemaakt zijn ten behoeve van de functie. Dat aantonen is niet de verantwoordelijkheid van het waterschap. Het waterschap moet voor de loonheffingen als inhoudingsplichtige wel aan de fiscus aannemelijk kunnen maken dat die reiskosten zakelijk waren, wil de vergoeding ervan onbelast kunnen geschieden. Daarbij mag het waterschap in beginsel uitgaan van de motivering van de ambtsdrager, tenzij die erg onwaarschijnlijk is of in strijd met de regels. Het waterschap toetst dus marginaal.
...
In beginsel zijn afzonderlijke vergoedingen voor parkeergelden belast, omdat daarnaast ook €0,19 per kilometer wordt vergoed. Deze parkeervergoedingen worden bij de werkgever belast, omdat zij op grond van [artikel 4.2.10, zesde lid](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.10), en [artikel 4.3.8, onder d, van het besluit](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.8) in de eindheffing worden betrokken.
...
In de [Waterschapswet](https://wetten.overheid.nl/jci1.3:c:BWBR0005108) wordt onderscheid gemaakt tussen financiële en niet-financiële voorzieningen. Niet alleen dit (overigens al jarenlang bestaande) onderscheid, maar ook de fiscale regelgeving hebben hun weerslag op de behandeling van de parkeervoorzieningen. Het antwoord op de vraag of een parkeervoorziening nu wel of niet kan worden vergoed of ter beschikking worden gesteld, kan daarom afhankelijk van de situatie nogal verschillen. Om deze reden worden hieronder verschillende varianten toegelicht.
...
Wanneer die parkeerplaatsen door het waterschap ter beschikking worden gesteld voor woon-werkverkeer of dienstreizen, is er in principe geen sprake van strijd met het vereiste van de [Waterschapswet](https://wetten.overheid.nl/jci1.3:c:BWBR0005108) dat er een juridische grondslag moet zijn voor geldelijke voorzieningen voor politieke ambtsdragers. Zolang er geen sprake is van vergoedingen ten laste van het waterschap aan die ambtsdragers, is er geen sprake van een geldelijke vergoeding die in strijd is met de [artikelen 32a](https://wetten.overheid.nl/jci1.3:c:BWBR0005108&artikel=32a), [44](https://wetten.overheid.nl/jci1.3:c:BWBR0005108&artikel=44) en [48 van de Waterschapswet](https://wetten.overheid.nl/jci1.3:c:BWBR0005108&artikel=48). Dan zijn die aan te merken als bedrijfsvoeringskosten van het waterschap: zij worden dan gezien als onderdeel van de werkplek.
...
Indien het waterschap dergelijke parkeerplaatsen voor woon-werkverkeer ter beschikking wil stellen aan leden van het algemeen bestuur en commissieleden, moet dat in een verordening worden opgenomen en behoeft die de goedkeuring van gedeputeerde staten. Dan is namelijk [artikel 32a, derde lid, van de Waterschapswet](https://wetten.overheid.nl/jci1.3:c:BWBR0005108&artikel=32a) van toepassing. Voor de voorzitter en de leden van het dagelijks bestuur hoeft dat niet omdat hun aanspraken voortvloeien uit het [rechtspositiebesluit](https://wetten.overheid.nl/jci1.3:c:BWBR0041522) en niet uit een verordening.
...
Voorop staat dat de kosten via openbaar vervoer van zakelijke reizen voor het waterschap (woon-werkverkeer en dienstreizen) worden vergoed door het waterschap. Daarbij is het uitgangspunt de werkelijke gemaakte kosten. Welke kaart wordt aangeboden, is een afweging die bij de verstrekker hoort.

Het meest eenvoudig is dat het waterschap een OV-kaart, en dat kan een Businesscard zijn, ter beschikking stelt aan de ambtsdrager en dat de ambtsdrager deze kaart uitsluitend gebruikt voor zakelijke reizen voor het waterschap. Het is dan aan betrokkene te bepalen of hij of zij een of andere kortingskaart koopt of houdt voor privéreizen.

Ingeval van een dienstauto is het recht op de andere reiskostenvergoedingen uitgesloten in het negende en tiende lid van [artikel 4.2.10](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.10).
...
Voor het gebruik van de motorfiets is in tegenstelling tot het gebruik van de eigen auto geen expliciete grondslag. Het voornemen is dit gebruik gelijk te stellen in [artikel 4.1, eerste lid, onder b, van het Regeling rechtspositie decentrale politieke ambtsdragers](https://wetten.overheid.nl/jci1.3:c:BWBR0041573&artikel=4.1). In veel regelingen zijn deze twee al gelijkgesteld en er is geen reden om daar op dit punt van af te wijken.
...
### 12. De presentievergoeding van commissieleden kan worden aangemerkt als een vrijwilligersvergoeding

De hoogte van de vergoeding van een commissielid is dwingend vastgelegd in [artikel 4.4.1 van het rechtspositiebesluit](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.1). Onder de in [artikel 4.4.2](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.2) genoemde voorwaarden kan het algemeen bestuur een hogere vergoeding vaststellen. De vergoeding is in principe belast. Deze is echter **onbelast** indien het waterschap de vergoeding voor commissieleden (onder de van toepassing zijnde fiscale voorwaarden) aanmerkt als vrijwilligersvergoeding. Met betrekking tot vergoedingen die waterschappen geven voor werkzaamheden die niet marktconform zijn en die ook blijven binnen de maand- en jaarbedragen kan de fiscale vrijwilligersregeling namelijk worden toegepast. Niet alle waterschappen zijn zich bewust van deze mogelijkheid; daarom wordt deze optie in onderstaande met het Ministerie van Financiën afgestemde tekst ten aanzien van de commissieleden beschreven.
...
Als het betrokken commissielid uitsluitend deze vergoeding krijgt, dan kan deze onder de gestelde voorwaarden worden aangemerkt als vrijwilligersvergoeding en is deze niet belast voor de loon- en inkomstenbelasting. Waterschappen kunnen dan hun commissieleden de zekerheid geven dat indien de grensbedragen van zowel € 170 per maand als € 1.700 per jaar niet worden overschreden, de commissievergoedingen onbelast zijn.

De commissieleden kunnen deze vergoedingen en verstrekkingen dan zonder inhouding van loonbelasting en premie voor de volksverzekeringen netto ontvangen van het waterschap. De vergoedingen maken dan ook geen onderdeel uit van het belastbare inkomen van het commissielid en hebben daarmee ook geen consequenties voor een eventuele inkomensafhankelijke toelage of een huur- of zorgtoeslag. Vrijwilligersvergoedingen worden ook niet verrekend met een eventuele bijstandsuitkering.

Indien een waterschap ervoor kiest voor de presentievergoeding gebruik te maken van vrijwilligersregeling heeft het geen meerwaarde dit vast te leggen in een verordening. De vrijwilligersvergoeding betreft namelijk de uitvoering van fiscale regelgeving. Als blijkt dat niet wordt voldaan aan de fiscale voorwaarden, is er geen sprake van een vrijwilligersvergoeding. Het waterschap kan wel betrokkenen melden dat zij ernaar streeft om gebruik te maken van de vrijwilligersregeling maar of aan de fiscale voorwaarden is voldaan, kan pas achteraf worden bekeken op basis van het aantal vergaderingen en de daaraan gekoppelde presentievergoedingen.

### 13. Toekenning jaarvergoedingen in gedeelten mogelijk

In het [rechtspositiebesluit](https://wetten.overheid.nl/jci1.3:c:BWBR0041522) en in de rechtspositieregeling worden ook wel bedragen genoemd per jaar of per periode. Een voorbeeld van het eerste is [artikel 4.1.10](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.10) (tegemoetkoming ziektekostenverzekering), een voorbeeld van het tweede is de toelage voor de rekenkamerfunctie. Indien het waterschap dat wenst, bijvoorbeeld om uitvoeringstechnische redenen, kunnen deze bedragen ook in gedeelten worden uitbetaald, bijvoorbeeld per maand.

Dit is een andere situatie dan beschreven in paragraaf 15 ten aanzien van [artikel 4.1.9](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.9). Daar gaat het om de vaststelling van een vergoeding naar rato ingeval van een kortere “diensttijd”. In deze paragraaf 13 is gedoeld op een wijze van uitbetaling van een bedrag dat als zodanig niet verandert. Het in [artikel 4.1.10](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.10) bedoelde totaalbedrag mag dus desgewenst ook per maand worden uitbetaald; het in artikel 4.1.9 bedoelde bedrag niet.

### 14. Vakantie-uitkering en eindejaarsuitkering voorzitters en leden van het dagelijks bestuur per 2020
...
### 15. Verzekering arbeidsongeschiktheid, ouderdom en overlijden leden van het algemeen bestuur

Wat betreft de Verzekering arbeidsongeschiktheid, ouderdom en overlijden voor AB-leden is het een verordeningsbevoegdheid is van het waterschap om te bepalen wanneer de uitbetaling plaatsvindt. Dat kan vooraf of achteraf, per kalenderjaar of van maart tot maart.

AB-leden die op grond van [artikel 4.1.11](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.11) vanwege een arbeidsongeschiktheidsuitkering een lagere vergoeding voor werkzaamheden ontvangen, hebben recht op het volledige in [artikel 4.1.9, eerste lid](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.9), genoemde bedrag. In dat lid is namelijk bepaald dat het gaat het om het bedrag van de vergoeding voor de werkzaamheden, bedoeld in [artikel 4.1.1, eerste lid](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.1), voor één maand.

Een andere vraag was of al dan niet naar rato moet worden toegekend als voor deze optie is gekozen. In [artikel 4.1.9](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.9) is niet zoals bijvoorbeeld in [artikel 4.1.10](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.10) (over de ziektekostenverzekering) expliciet vermeld dat een lid van het algemeen bestuur dat in de loop van een maand is beëdigd of in de loop van een maand is afgetreden of overleden, het bedrag naar evenredigheid ontvangt van de periode van uitoefening van het lidmaatschap in de betreffende maand. Dit was ook al zo in de rechtspositiebesluiten van raads- en statenleden waarvan dit artikel is afgeleid.

Dit onderscheid is bij nader inzien niet logisch en ook niet gewenst. Op dit moment betekent dit dat een waterschap, indien het algemeen bestuur kiest voor toepassing van [artikel 4.1.9](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.9), hetzelfde bedrag per jaar moet toekennen aan een lid van het algemeen bestuur dat het hele jaar in functie is als een lid van het algemeen bestuur dat een kortere periode de functie vervult of vervuld heeft.

Het voornemen is om [artikel 4.1.9](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.9) in die zin aan te passen dat deze wel naar rato wordt toegekend. Omdat deze wijziging een beperking van het huidige recht betekent, kan zij echter niet met terugwerkende kracht worden toegepast.

### 16. Fiscale aspecten onkostenvergoedingen

### 16.a. Onkostenvergoeding geen gerichte vrijstelling

In de [circulaire van 30 januari 2019](https://wetten.overheid.nl/jci1.3:c:BWBR0041882) staan enkele zinsneden die in tegenspraak met elkaar zijn. Enerzijds wordt in [§3](onbekend) beschreven waarom de vaste onkostenvergoedingen van ambtsdragers onder de vrije ruimte van de Werkkostenregeling zijn gebracht. Anderzijds wordt in de artikelsgewijze toelichting bij [artikel 4.3.8](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.8) “Eindheffingsbestanddelen” opgemerkt dat de vaste onkostenvergoedingen een gerichte vrijstelling zijn.

Deze formulering is per abuis iets te ruim gesteld. De algemene ambtstoelage is namelijk een vergoeding die niet onder een specifieke gerichte vrijstelling kan worden gebracht. Dat volgt eigenlijk al uit [§3 van de circulaire](onbekend), waar vermeld staat “mits de desbetreffende vergoedingen, verstrekkingen en terbeschikkingstellingen binnen de normen blijven die voor deze gerichte vrijstellingen gelden”.

Voor alle duidelijkheid is de situatie als volgt:

De ambtstoelagen zijn in het [rechtspositiebesluit](https://wetten.overheid.nl/jci1.3:c:BWBR0041522) aangewezen als eindheffingsbestanddeel om ze buiten het individuele loon van de werknemer te plaatsen. Nu dat in formele regelgeving is voorgeschreven aan waterschappen, is de uitbetaling aan de politieke ambtsdrager netto (zoals vermeld bij de toelichting bij [artikel 4.2.6](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.6)). Vervolgens moet worden bezien wat het waterschap als inhoudingsplichtige te doen staat. Als voor een specifieke vergoeding NIET een gerichte vrijstelling van toepassing is (zoals voor de ambtstoelage), maakt de als eindheffingsbestanddeel aangewezen vergoeding onderdeel uit van de vrije ruimte en zal bij overschrijding van de vrije ruimte het waterschap zelf een heffing van 80% over de overschrijding verschuldigd zijn. Als WEL een gerichte vrijstelling van toepassing is (zoals bij verhuizing) is de vergoeding om die reden vrij van heffing voor het waterschap (de vergoeding hoeft dan niet de vrije ruimte in en kan dus ook niet leiden tot een overschrijding).

### 16.b. Geen kostenonderzoek vaste kostenvergoeding om (op onderdelen) een specifieke gerichte vrijstelling van toepassing te laten zijn
...
Natuurlijk is het bevredigend voor het waterschap als er geen belasting hoeft te worden betaald, maar als de grens van de vrije ruimte wordt overschreden, is er sprake van reguliere belastingheffing. En wanneer het komt tot die belastingheffing, leidt die tot lagere kosten voor de werkgever dan bij het alternatief, bruteren. In [§3 van de circulaire van 30 januari 2019](onbekend) is hierop uitgebreid ingegaan. Kortheidshalve wordt op deze plaats hiernaar verwezen.
...
- •. **Nieuwe opzet:** [circulaire 30 januari 2019, §2](onbekend)

- •. **Fiscale aspecten:** [circulaire 30 januari 2019, §3](onbekend) **en deze circulaire** **§16**

- •. **Reiskostensysteem:** [circulaire 30 januari 2019, §4](onbekend), Vereenvoudiging reiskostenvergoeding

- •. **Reiskosten leden van het algemeen bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.7](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.7)**en deze circulaire §6, §7, §8, §9, §10, §11**

- •. **Reiskosten voorzitter of lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §4, Vereenvoudiging reiskostenvergoeding en §5](onbekend), [artikel 4.2.9](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.9)**, alsmede deze circulaire §4, §5, §6, §7, §8, §9, §10, §11**

- •. **Reiskosten commissieleden:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.4.3](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.3)**en deze circulaire §6, §7, §8, §9, §10, §11**

- •. **Ter beschikking gestelde auto (dienstauto/leaseauto):** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.10](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.10)**(inclusief vier voorbeelden) alsmede deze circulaire §4 en §5**
...
- •. **Tol- en veergelden:** [circulaire 30 januari 2019, §4](onbekend), Vereenvoudiging reiskostenvergoeding

- •. **Boetes en naheffingsaanslagen voor parkeren:** [circulaire 30 januari 2019, §4](onbekend), Vereenvoudiging reiskostenvergoeding

- •. **Indexcijfers:** [circulaire 30 januari 2019, §4](onbekend)

- •. **Loopbaanoriëntatie:** [circulaire 30 januari 2019, §4](onbekend)

- •. **Flexibel Pensioen en Uittreden (FPU):** [circulaire 30 januari 2019, §4](onbekend)

- •. **Wijze van declareren:** [circulaire 30 januari 2019, §4](onbekend)

- •. **Koppeling aan Arbeidvoorwaardenovereenkomst sector Rijk:** [circulaire 30 januari 2019, §4](onbekend)

- •. **Wijze van declareren:** [circulaire 30 januari 2019, §4](onbekend)

- •. **Toekenning jaarvergoeding in gedeelten mogelijk:** deze circulaire §13

- •. **Definitie Fractievoorzitter:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1)

- •. **Definitie Commissielid:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1)

- •. **Vergoeding voor de werkzaamheden:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.1](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.1)

- •. **Toelage lid vertrouwenscommissie:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.2 tot en met 4.1.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.2)

- •. **Toelage lid rekenkamerfunctie:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.2 tot en met 4.1.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.2)

- •. **Toelage lid onderzoekscommissie:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.2 tot en met 4.1.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.2)

- •. **Toelage lid bijzondere commissie:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.2 tot en met 4.1.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.2)

- •. **Toelage fractievoorzitter:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.5](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.5)

- •. **Onkostenvergoeding leden van het algemeen bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.6](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.6)

- •. **Verzekering arbeidsongeschiktheid, ouderdom en overlijden leden van het algemeen bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.9](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.9)**en deze circulaire,**§15

- •. **Ziektekostenverzekering leden van het algemeen bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.10](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.10)

- •. **Samenloop met arbeidsongeschiktheidsuitkering:** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.1.11](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.11) en [2.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=2.4.4), **alsmede** circulaire Samenloop vergoedingen leden van het algemeen bestuur met een uitkering

- •. **Waarneming door lid van het algemeen bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.12](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.12)

- •. **Vergoeding tijdelijk ontslagen lid van het algemeen bestuur voor werkzaamheden en onkostenvergoeding:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.1.13](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.1.13)

- •. **Bezoldiging en uitkeringen voorzitter en lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.1](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.1)

- •. **Vakantie-uitkering en eindejaarsuitkering voorzitter en lid van het dagelijks bestuur per 2020:** deze circulaire §14

- •. **Waarneming door lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.2](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.2)

- •. **Verrekening neveninkomsten:** [circulaire 30 januari 2019, §5](onbekend), [artikel 2.2.3](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=2.2.3)**en de** circulaire met betrekking tot de verrekening over het verrekenjaar 2018

- •. **Uitkering bij overlijden voorzitter of lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.4)

- •. **Ambtskosten voorzitter of lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.6](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.6)

- •. **Verhuiskostenvergoeding:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.7](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.7)

- •. **Terugkeer wegens dringende reden voorzitter of lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.12](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.12)

- •. **Aanspraken bij zwangerschap en bevalling ziekte voorzitter of lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.13](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.13)

- •. **Vergoeding bij waarneming van de voorzitter:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.14](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.14)

- •. **Verzekering voor arbeidsongeschiktheid, ouderdom en overlijden tijdelijke vervanger lid van het dagelijks bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.15](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.15)

- •. **Kennisgeving bij afwezigheid voorzitter:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.17](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.17)

- •. **Schorsing voorzitter:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.18](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.18)

- •. **Ontslag voorzitter:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.2.19](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.2.19)

- •. **Stelsel Bewaken en Beveiligen** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.3.1](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.1) en [4.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.4)

- •. **Informatie- en Communicatievoorzieningen (ICT):** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.3.2](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.2) en [4.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.4)**, alsmede deze circulaire, §2 en §3**

- •. **Vergoeding kosten scholing:** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.3.3](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.3) en [4.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.4)

- •. **Contributie beroepsvereniging voorzitter, lid van het dagelijks bestuur, leden van het algemeen bestuur, commissieleden:** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.3.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.4) en [4.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.4)

- •. **Bedrijfsgeneeskundige zorg voorzitter, lid van het dagelijks bestuur, leden van het algemeen bestuur:** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.3.5](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.5)

- •. **Voorzieningen in verband met een beroepsziekte of een dienstongeval:** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.3.6](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.6) en [4.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.4)

- •. **Voorzieningen in verband met een structurele functionele beperking:** [circulaire 30 januari 2019, §5](onbekend), [artikelen 4.3.7](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.7) en [4.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.4)

- •. **Eindheffingsbestanddelen:** [circulaire 30 januari 2019, §3 en §5](onbekend), [artikelen 4.3.8](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.3.8) en [4.4.4](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.4)

- •. **Vergoeding voor het bijwonen van de vergaderingen commissieleden:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.4.1](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.1)

- •. **Hogere vergoeding commissieleden:** [circulaire 30 januari 2019, §5](onbekend), [artikel 4.4.2](https://wetten.overheid.nl/jci1.3:c:BWBR0041522&artikel=4.4.2)

- •. **Presentievergoeding commissieleden kan worden aangemerkt als een vrijwilligersvergoeding:** deze circulaire §12.
